...
use yii\helpers\Url;
$this->title = 'Vintapes - search';
?>

<div class="w-full" name="top">

<div class="grid grid-cols-2 gap-x-4 gap-y-10 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8" data-v-d580b1ea="">

<?php foreach($packs as $pack): ?>
    <!--<div class="group swiper-slide  shrink-0 focus:outline-none px-3">
