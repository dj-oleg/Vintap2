         ...
         <div data-v-b2a31b8e="" class="flex flex-wrap items-center sm:flex-nowrap">
            ...
            <div data-v-b2a31b8e="" class="mt-5 w-full sm:mt-0 sm:ml-12 sm:w-auto">
               <div data-v-b2a31b8e="" class="flex items-center">
                  ...
                  <button data-v-b2a31b8e="" id_creator="<?=$creator['id']?>" class="btn-like-c grid h-8 w-8 place-content-center rounded-full bg-black bg-opacity-[0.08] hover:bg-opacity-10 dark:bg-white dark:bg-opacity-[0.16] dark:hover:bg-opacity-20" style="margin-left:20px;">
