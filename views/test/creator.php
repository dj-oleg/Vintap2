...
<div class="w-full">
   <div data-v-b2a31b8e="" class="relative">
      <div data-v-b2a31b8e="" class="bg-glow" style="box-shadow: rgba(168, 161, 160, 0.25) 0px -125px 200px 225px;"></div>
      <div data-v-b2a31b8e="" class="relative z-[1]">
         <div data-v-b2a31b8e="" class="-mt-4 mb-10 sm:-mt-2">
            <div data-v-b2a31b8e="" class="hidden items-center text-[13px] sm:flex">
               <a data-v-b2a31b8e="" href="<?=Url::to(['site/creators'])?>" class="mr-2 hover:underline">All creators</a>
               <span data-v-b2a31b8e="" class="inline-flex items-center text-5c5c5c dark:text-[#b7b7b7]">
                  <svg data-v-b2a31b8e="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2 h-3 w-3 rotate-180">
            ...
            <a data-v-b2a31b8e="" href="/creators" class="flex items-center text-[15px] hover:underline sm:hidden">
               <svg data-v-b2a31b8e="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2 h-4 w-4">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M13.8443 18.3839C13.3562 18.872 12.5647 18.872 12.0766 18.3839L3.28946 9.59677L11.2701 1.61612C11.7583 1.12796 12.5497 1.12796 13.0379 1.61612C13.526 2.10427 13.526 2.89573 13.0379 3.38388L6.82499 9.59677L13.8443 16.6161C14.3325 17.1043 14.3325 17.8957 13.8443 18.3839Z" class="fill-current"></path>
               </svg>
               Explore all creators
            </a>
         </div>
         <div data-v-b2a31b8e="" class="flex flex-wrap items-center sm:flex-nowrap">
            <div data-v-b2a31b8e="" class="relative">
               <div data-v-b2a31b8e="" class="relative h-[124px] w-[124px] max-w-full shrink-0 overflow-hidden rounded-full border border-black/[0.12] dark:border-white/[0.12] sm:h-[196px] sm:w-[196px]"><img data-v-b2a31b8e="" class="h-full w-full object-cover" src="<?=Yii::$app->request->baseUrl?>/modx/<?=($creator['image']!="")?$creator['image']:'images/user_photo/user_icon.png'?>"></div>
               <!---->
            </div>
            <div data-v-b2a31b8e="" class="mt-5 w-full sm:mt-0 sm:ml-12 sm:w-auto">
               <div data-v-b2a31b8e="" class="flex items-center">
                  <h1 data-v-b2a31b8e="" class="mr-2 text-[28px] font-medium leading-8 sm:text-[33px] sm:leading-10"><?=$creator['name']?></h1>
                  <button data-v-b2a31b8e="" id_creator="<?=$creator['id']?>" class="btn-like-c grid h-8 w-8 place-content-center rounded-full bg-black bg-opacity-[0.08] hover:bg-opacity-10 dark:bg-white dark:bg-opacity-[0.16] dark:hover:bg-opacity-20">
                     <svg data-v-b2a31b8e="" width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4">
                       <?php if((isset($user_likes_creators))&&(in_array($creator['id'], $user_likes_creators))):?>
               ...
               <div data-v-b2a31b8e="" class="mt-2 flex items-center">
                  <svg data-v-b2a31b8e="" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-1.5 h-3.5 w-3.5">
                  ...
                  <span data-v-b2a31b8e="" class="mr-5"><?=$creator['count_samples']?> Samples</span>
                  <svg data-v-b2a31b8e="" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-1.5 h-3.5 w-3.5">
                  ...
                  <span data-v-b2a31b8e=""><?=$creator['count_packs']?> Packs</span>
               </div>
               <div data-v-b2a31b8e="" class="mt-4 sm:max-w-[368px]">
                 <span data-v-b2a31b8e="" class="inline text-[#5C5C5C] dark:text-[#B7B7B7]">
                   <?=$creator['description']?>
                 </span>
                 <button data-v-b2a31b8e="" type="button" class="inline-block underline hover:no-underline dark:text-white">
                  View more
                  </button>
               </div>
               <!----> <!---->
      ...
      <div data-v-b2a31b8e="" class="-mx-4 sm:hidden">
         <div data-v-b2a31b8e="" class="my-10 h-px bg-black bg-opacity-[0.12] dark:bg-white dark:bg-opacity-[0.12]"></div>
      </div>
      <!--Trending-->
      <div data-v-b2a31b8e="" class="sm:mt-16">
         <div data-v-b2a31b8e="" class="overflow-hidden">
            <div class="flex items-center">
               <div class="flex w-full items-center space-x-3 sm:w-auto">
                  <h2 class="text-xl font-medium leading-[18px] tracking-[-0.25px] sm:text-[28px] sm:leading-8">Packs</h2>
                  <!---->
               </div>
            ...
            <!---->
                  ...
                  <div class="swiper mt-5">
                     <div class="swiper-wrapper flex -mx-3">
                       ...
                       <?php foreach($packs_creator as $pack): ?>
                            ...
                            <div data-v-66887fe6="" class="popper filter-dropdown p-5" style="min-width: 270px; position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 51px, 0px);" x-placement="bottom-start">
                               <div data-v-66887fe6="" class="px-2 pt-2 pb-2" value="40,300">
                                  ...
                                  <div class="mt-5 flex items-center space-x-5 lg:justify-between">
                                     <div><label class="mb-1 block text-xs font-medium leading-4 text-5c5c5c dark:text-[#b7b7b7]">From</label>
                                        <input type="number" min="40" max="300" value="<?=(isset($tempo_low))?$tempo_low:40?>" id="tempo_low" class="tempo text-number form-field w-[100px] appearance-none rounded-md border-black/[0.16] px-3 py-2 text-[15px] leading-[18px] shadow-[0px_1px_1px_rgba(0,0,0,0.025)] focus:border-purple dark:border-white/[0.16] dark:bg-white/[0.16] dark:focus:border-purple"></div>
                                     <div class="relative top-2.5 h-px w-8 bg-black/[0.24] dark:bg-white/[0.32]"></div>
                                     <div><label class="mb-1 block text-xs font-medium leading-4 text-5c5c5c dark:text-[#b7b7b7]">To</label>
                                        <input type="number" min="40" max="300" value="<?=(isset($tempo_high))?$tempo_high:300?>" id="tempo_high" class="tempo text-number form-field w-[100px] appearance-none rounded-md border-black/[0.16] px-3 py-2 text-[15px] leading-[18px] shadow-[0px_1px_1px_rgba(0,0,0,0.025)] focus:border-purple dark:border-white/[0.16] dark:bg-white/[0.16] dark:focus:border-purple"></div>
                                  </div>
                                  ...
                                  <div class="mt-5 hidden space-x-3 text-right lg:block">
                                    <button id="btn_tempo_clear" class="btn-white-outline">Clear</button>
                                    <button id="btn_tempo_apply" class="btn-purple">Apply filter</button>
                                  </div>
                               </div>
                            </div>
                         </span>
                           <p class="flex items-center whitespace-nowrap" data-v-66887fe6>
                              <button type="button" class="dropdown-btn flex items-center rounded-lg border-2 py-1 px-2.5 leading-[18px] text-5c5c5c dark:bg-[#2d2d2d] dark:text-[#dedede] border-black/[0.12] hover:border-[#bfbfbf] dark:border-white/[0.12] dark:hover:border-[#5e5e5e]" data-v-66887fe6 style="<?=((isset($tempo_low))||(isset($tempo_high)))?'border-color: rgb(85 43 252)':''?>">
                                 <span data-v-66887fe6>
                                    Tempo<?=((isset($tempo_low))||(isset($tempo_high)))?':':''?>
                                 </span>
                                 <span class="ml-1.5 drdw" data-v-66887fe6>
                                   <?php if((isset($tempo_low))||(isset($tempo_high))): ?>
                                    <?php
                                       echo $tempo_low."-".$tempo_high;
                                    ?>
                                   <?php else: ?>
         ...
         <div class="overflow-x-auto overflow-y-hidden">
            <table class="sample-list relative w-full table-auto">
               ...
               <tbody id="songs_table">
                 ...
                 <?php if (isset($sounds)): ?>
                 <?=$this->context->songs_html($sounds)?>
                 <?php endif; ?>
      ...
      <div data-v-b2a31b8e="" class="overflow-hidden sm:mt-28">
         <div class="flex items-center">
            <div class="flex w-full items-center space-x-3 sm:w-auto">
               <h2 class="text-xl font-medium leading-[18px] tracking-[-0.25px] sm:text-[28px] sm:leading-8">Similar creators</h2>
               <a href="<?=Url::to(['site/creators'])?>" class="btn-view-all">
               View all
               </a>
            </div>
            <div class="ml-auto hidden space-x-2.5 text-[0px] sm:block">
               <button class="slider-prev h-8 w-8 rounded-full border-2 border-solid border-black/[0.12] text-black transition-colors hover:opacity-70 focus:outline-none dark:border-white/[0.24] dark:bg-black/[0.48] dark:text-white opacity-50 cursor-default" tabindex="-1" role="button" aria-label="Previous slide" aria-disabled="true">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" class="mx-auto w-3.5 rotate-180 transform">
                     <path d="M4.71229 9.95496L8.4246 6.24265L4.71229 2.53034L5.77295 1.46968L10.5459 6.24266L5.77295 11.0156L4.71229 9.95496Z" fill="currentColor"></path>
                     <path d="M10 6.25C10 6.66421 9.66421 7 9.25 7L1 7L1 5.5L9.25 5.5C9.66421 5.5 10 5.83579 10 6.25Z" fill="currentColor"></path>
                  </svg>
               </button>
               <button class="slider-next h-8 w-8 rounded-full border-2 border-solid border-black/[0.12] text-black transition-colors hover:opacity-70 focus:outline-none dark:border-white/[0.24] dark:bg-black/[0.48] dark:text-white" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" class="mx-auto w-3.5">
                     <path d="M4.71229 9.95496L8.4246 6.24265L4.71229 2.53034L5.77295 1.46968L10.5459 6.24266L5.77295 11.0156L4.71229 9.95496Z" fill="currentColor"></path>
                     <path d="M10 6.25C10 6.66421 9.66421 7 9.25 7L1 7L1 5.5L9.25 5.5C9.66421 5.5 10 5.83579 10 6.25Z" fill="currentColor"></path>
                  </svg>
         ...
         <!---->
         <div class="swiper mt-5 swiper-container swiper-container-initialized swiper-container-horizontal">
            <div class="swiper-wrapper flex" style="transform: translate3d(0px, 0px, 0px);">
              <?php if(isset($similar_creators)):?>
              <?php foreach ($similar_creators as $key => $creator):?>
               <a href="<?=Url::to(['site/creator','id'=>$creator['id']])?>" class="group relative swiper-slide w-1/6 shrink-0 focus:outline-none swiper-slide-active" style="width: 139px; margin-right: 24px;">
                  <div class="relative">
                     <div class="relative mx-auto block h-28 w-28 rounded-full border border-black/[0.08] dark:border-white/[0.08] sm:h-[132px] sm:w-[132px]">
                        <img loading="lazy" alt="" class="absolute inset-0 w-full rounded-full" src="<?=Yii::$app->request->baseUrl?>/modx/<?=($creator['image']!="")?$creator['image']:'images/user_photo/user_icon.png'?>"> <!---->
                     </div>
                  </div>
      ...
      <div data-v-b2a31b8e="" class="mt-16 pb-14 text-center md:mt-20 md:pb-[72px]">
...
baseurl = "/site/creator/$id";

$('body').on('click', 'button.btn-like-c', function() {
  //alert('like');
  var id_creator = $(this).attr('id_creator');
  var obj = $(this).children();
  $.ajax({
        method: "POST",
        url: 'http://vintapes.com/ajax/like_creators',
        data: { id_creator: id_creator}
      })
        .done(function( rez ) {
          //alert( "rez: " + rez );
          if(rez=='add'){
            obj.html('<path d="M21.6612 1.449C20.569 0.467434 19.1675 -0.0397535 17.7518 0.002434C15.9945 0.002434 14.2208 0.724309 12.9237 2.064L12.0003 3.01415L11.0768 2.064C9.7784 0.724309 8.00653 0.002434 6.24871 0.002434C4.83309 0.002434 3.43293 0.467902 2.29902 1.449C-0.61379 3.9704 -0.759571 8.46618 1.86637 11.1802L10.9226 19.5412C11.2222 19.8477 11.6065 20.0024 11.9956 20.0024C12.3862 20.0024 12.7779 19.8493 13.0742 19.5429L22.1258 11.1819C24.7597 8.46337 24.6143 3.96806 21.6612 1.449Z" class="fill-current"></path>');
          }
          if(rez=='remove'){
            obj.html('<path fill-rule="evenodd" clip-rule="evenodd" d="M17.7518 0.002434C19.1675 -0.0397535 20.569 0.467434 21.6612 1.449C24.6143 3.96806 24.7597 8.46337 22.1258 11.1819L13.0742 19.5429C12.7779 19.8493 12.3862 20.0024 11.9956 20.0024C11.6065 20.0024 11.2222 19.8477 10.9226 19.5412L1.86637 11.1802C-0.759571 8.46618 -0.61379 3.9704 2.29902 1.449C3.43293 0.467902 4.83309 0.002434 6.24871 0.002434C8.00653 0.002434 9.7784 0.724309 11.0768 2.064L12.0003 3.01415L12.9237 2.064C14.2208 0.724309 15.9945 0.002434 17.7518 0.002434ZM12.0001 6.97862L14.9727 3.82391C15.5314 3.2312 16.4073 2.73126 17.3555 2.57758C18.2908 2.42598 19.2731 2.61278 20.1057 3.35279C22.0326 5.06964 21.7737 7.89396 20.3724 9.39492L11.9986 17.2849L3.62198 9.39485C2.24625 7.92158 1.95122 5.04376 3.88949 3.35679L3.89373 3.35302C4.72161 2.61638 5.70026 2.42538 6.63443 2.57376C7.58087 2.72408 8.45918 3.2215 9.02705 3.82393L12.0001 6.97862Z" class="fill-current"></path>');
          }
