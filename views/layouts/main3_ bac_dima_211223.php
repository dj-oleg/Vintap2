...
<!--<noscript data-n-head="ssr" data-hid="gtm-noscript" data-pbody="true">
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TTBCHT6&" height="0" width="0" style="display:none;visibility:hidden" title="gtm"></iframe>
      </noscript>-->
<div data-server-rendered="true" id="__nuxt">
    ...
    <div id="__layout">
        <div class="bg-white font-circular-std text-sm font-normal text-black antialiased dark:bg-121212 dark:text-white explore-page <?=(isset($promo))?'pt-9':''?>" style="margin-top:-37px"><!--pt-9-->
                ...
                <div class="box-small" data-v-1fee5f17>
                    <div class="flex items-center" data-v-1fee5f17>
                        ...
                        <div class="flex items-center" data-v-1fee5f17>
                            ...
                            <!--<a href="account/downloads.html" class="shrink-0 lg:ml-0 nuxt-link-active ml-auto" data-v-1fee5f17>
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 113 35" class="w-20 lg:w-24" data-v-1fee5f17>
                                 <defs>
                                    <clipPath id="maqra">
                            ...
                            <div class="ml-6 hidden w-full lg:block" data-v-1fee5f17>
                                <form class="" action="<?=Url::to(['site/search'])?>" data-v-1fee5f17>
                                    ...
                                    <!--<button type="submit" class="absolute right-[13px] top-1/2 z-10 -translate-y-1/2" data-v-1fee5f17>
                                    <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-[22px] w-[22px] text-[#b7b7b7] group-hover:text-white" data-v-1fee5f17>
                                 ...
                                 <span style="display:none;" class="">
                                    <div class="popper relative top-2 overflow-hidden whitespace-nowrap rounded bg-white px-5 py-2 shadow-xl dark:bg-121212" style="width:150px;" data-v-1fee5f17="">
                                       <div data-v-1fee5f17="" class="vue-slider vue-slider-ltr" style="padding: 7px 0px; width: auto; height: 4px;">
                                        ...
                                        <!--<button  class="group hidden h-10 w-10 rounded-full bg-black/[0.06] text-center transition-colors hover:bg-[#dedede] dark:bg-white/[0.16] dark:hover:bg-white/30 lg:block" data-v-1fee5f17="">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" volume="full" class="mx-auto h-[20px] w-[20px] transition-transform duration-300 group-hover:scale-[1.10]" data-v-1fee5f17="">
                                       <path fill-rule="evenodd" clip-rule="evenodd" d="M10.2958 2.36086C10.2958 2.08551 10.13 1.83727 9.87558 1.7319C9.62119 1.62652 9.32837 1.68477 9.13367 1.87947L5.43254 5.5806H3.11418C2.81868 5.5806 2.53528 5.69799 2.32634 5.90694C2.11739 6.11589 2 6.39928 2 6.69478V9.29513C2 9.59063 2.11739 9.87403 2.32634 10.083C2.53529 10.2919 2.81868 10.4093 3.11418 10.4093H5.43254L9.13367 14.1104C9.32837 14.3051 9.62119 14.3634 9.87558 14.258C10.13 14.1526 10.2958 13.9044 10.2958 13.6291V2.36086ZM6.19592 6.74278L8.93427 4.00442V11.9855L6.19592 9.24713C6.06825 9.11946 5.89509 9.04774 5.71453 9.04774H3.36157V6.94217H5.71453C5.89509 6.94217 6.06825 6.87045 6.19592 6.74278ZM12.4251 5.20308C12.1039 5.00757 11.6851 5.10942 11.4895 5.43058C11.294 5.75173 11.3959 6.17058 11.717 6.36609C11.9984 6.53737 12.2309 6.77817 12.3923 7.06533C12.5537 7.35248 12.6384 7.67633 12.6384 8.00572C12.6384 8.33511 12.5537 8.65896 12.3923 8.94611C12.2309 9.23327 11.9984 9.47407 11.717 9.64535C11.3959 9.84086 11.294 10.2597 11.4895 10.5809C11.6851 10.902 12.1039 11.0039 12.4251 10.8084C12.906 10.5156 13.3035 10.104 13.5793 9.61314C13.8551 9.12231 14 8.56875 14 8.00572C14 7.44269 13.8551 6.88913 13.5793 6.3983C13.3035 5.90746 12.906 5.49586 12.4251 5.20308Z" class="fill-current"></path>
                                    </svg>
                                 </button>-->
                              </span>
                                    <!---->
                                          ...
                                          <li>
                                             <div class="rounded-[10px] py-2 px-3 hover:bg-[#dedede] dark:hover:bg-white/[0.16]">
                                                <div class="toggle-new flex w-full items-center">
                                                   <!--<div class="inline-flex flex-1 items-center space-x-3">
                        ...
                        <div class="flex items-center justify-between" data-v-1fee5f17>
                            ...
                            <?php if(!Yii::$app->user->isGuest): ?>
                                ...
                                <div class="flex items-center space-x-8" data-v-1fee5f17="">
                                    ...
                                    <!--<div class="inline-flex items-center whitespace-nowrap" data-v-1fee5f17="">
                                  <a href="/pricing" class="shrink-0 border-b-2 border-b-transparent pb-[7px] leading-[18px] transition-colors duration-300 hover:border-b-purple" data-v-1fee5f17="">
                                  0 credits
                                </a>
                                  <button type="button" class="ml-2 w-4 pb-2 hover:opacity-80" data-v-1fee5f17="">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-1fee5f17="">
                ...
                <div class="block pt-3 lg:hidden box-small" data-v-1fee5f17>
                    <form class="" action="<?=Url::to(['site/search'])?>" data-v-1fee5f17>
                        ...
                        <button type="submit" class="absolute right-[13px] top-1/2 z-[5] -translate-y-1/2" data-v-1fee5f17>
                            <!--<svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-[22px] w-[22px] text-5c5c5c dark:text-[#b7b7b7]" data-v-1fee5f17 style="margin-top: 55px;margin-right: 15px">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M28.0625 11.5923C28.0625 17.4768 23.2921 22.2471 17.4077 22.2471C14.8591 22.2471 12.5194 21.3523 10.6859 19.8597L2.25568 28.2898C1.82891 28.7166 1.13699 28.7166 0.710226 28.2898V28.2898C0.283462 27.8631 0.283461 27.1711 0.710226 26.7444L9.1404 18.3142C7.64773 16.4806 6.75287 14.141 6.75287 11.5923C6.75287 5.70782 11.5232 0.9375 17.4077 0.9375C23.2921 0.9375 28.0625 5.70782 28.0625 11.5923ZM25.8769 11.5923C25.8769 16.2697 22.0851 20.0615 17.4077 20.0615C12.7303 20.0615 8.93847 16.2697 8.93847 11.5923C8.93847 6.91489 12.7303 3.1231 17.4077 3.1231C22.0851 3.1231 25.8769 6.91489 25.8769 11.5923Z" class="fill-current"></path>
                           </svg>-->
                        </button>
                    </form>
            ...
            <?php if(Yii::$app->controller->action->id == 'explore' || Yii::$app->controller->action->id == 'explore2') : ?>


                
<div class="main-slader swiper-wrapper2 flex ms-bg-white dark:ms-bg-black" id="slider_1" current_slide="1" style="width: 100%;overflow: hidden; height:500px;">
<?php $main_slider = $this->context->get_main_slader_pack(); ?>
  <?php $key=0; foreach ($main_slider as $pack): $key++; ?>
<?php //echo2($this->context->GetColorImg('/modx/'.$pack['img'])); ?>

    <div id="slider_1_slade_<?=$key?>" class="theslade swiper-slide relative flex min-h-[440px] w-full shrink-0 flex-wrap overflow-hidden md:min-h-[420px] md:items-center md:rounded lg:flex-nowrap"
      style="width:100%"  data-v-6d5fe847>
       <div class=" absolute inset-0 z-[1]" data-v-6d5fe847></div>
<div style="max-width:1312px;margin: 0 auto" class="flex w-full">

       <div class="order-first w-full md:w-auto lg:order-last " data-v-6d5fe847 style="display: -webkit-box;margin-left: auto; margin-top:-15px;">
         <img alt="Slider" src="<?=Yii::$app->request->baseUrl?>/modx/<?=$pack['img']?>" class="img-slider" >
       </div>
       <div class="sn:pb-9 absolute bottom-0 left-0 z-[2] order-last w-full px-5 pt-0 pb-5 text-black dark:text-white sm:text-center md:relative md:w-1/2 md:text-left lg:order-first lg:max-w-xl lg:p-12 lg:pr-0" data-v-6d5fe847>
          ...
          <div data-v-6d5fe847>
             ...
             <p class="my-5 text-[15px] leading-[22px] text-black dark:text-[#b7b7b7]" data-v-6d5fe847>
                <?=$pack['description']?>

             </p>
             <div class="mt-6 flex items-center space-x-6 sm:justify-center md:justify-start" data-v-6d5fe847>
                <a href="<?=Url::to(['site/pack'])?>/<?=$pack['id']?>" class="btn-white2" data-v-6d5fe847>Browse Pack</a>

                <button pause="yes" audio_id="<?=$pack['id']?>" class="play-btn flex items-center space-x-3 focus:outline-none lg:pl-5" data-v-6d5fe847>
                   <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="play-btn h-8 w-8 text-black/[0.16] dark:text-white/[0.16] dark:backdrop-blur-lg lg:h-10 lg:w-10" data-v-d5f1e0b0 data-v-6d5fe847>
               ...
               <img src="<?=Yii::$app->request->baseUrl?>/img/lines<?=rand(1, 5)?>.png" class="waveimgwhite dark:waveimg testImg">
             <div class="mt-10 flex items-center space-x-3 text-[0px] sm:justify-center md:justify-start" data-v-6d5fe847>
                <button class="swiper-prev text-black dark:text-white transition-colors hover:opacity-70 focus:outline-none" data-v-6d5fe847>
                ...
                <div class="text-sm leading-[18px] text-black dark:text-white" data-v-6d5fe847>
                  <span data-v-6d5fe847><?=$key?></span> of <span data-v-6d5fe847><?=count($main_slider)?></span></div>
                <button class="swiper-next text-black dark:text-white transition-colors hover:opacity-70 focus:outline-none" data-v-6d5fe847>
  ...
  <?php endforeach; ?>
    ...
    .swiper-slide img {
      ...
      <div class="swiper-slide">Slide 9</div> -->
                        ...
                        <?php $key=0; foreach ($main_slider as $pack): $key++; ?>
                            ...
                            //  var_dump($pack['creator_id']);
                            // pack_info
                            // echo "Hello";
                            // echo $pack['id'];
                            $pricePack = $this->context->pack_info($pack['id'])['price'];
                            // var_dump($this->context->pack_info($pack['id'])['price']);
                            // var_dump($this->context->pack_info(315));
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class=" absolute inset-0 z-[1]" data-v-6d5fe847></div>
                                <div style="max-width:1312px;margin: 0 auto" class="flex w-full myFlex">

                                    <div style="padding-left:25%" class="order-first w-full md:w-auto lg:order-last myTop" data-v-6d5fe847 style="display: -webkit-box;margin-left: auto; margin-top:-15px;">
                                        <div class="myTestleftImg"></div>
                                        <img width="90%" alt="Slider" src="<?=Yii::$app->request->baseUrl?>/modx/<?=$pack['img']?>" class="img-slider" >
                                    </div>
                                    <div class="sn:pb-9 absolute bottom-0 left-0 z-[2] order-last w-full px-5 pt-0 pb-5 text-black dark:text-white sm:text-center md:relative md:w-1/2 md:text-left lg:order-first lg:max-w-xl lg:p-12 lg:pr-0 myBottom" data-v-6d5fe847>

                                        <h2 class="text-[33px] font-medium MyFontMedium leading-10 -tracking-[0.4px] sm:text-[40px] sm:leading-[48px]" data-v-6d5fe847><?= substr($pack['title'], 0, 21);?></h2>
                                        <div data-v-6d5fe847 class='myBottomBot'>
                                            <div class="authoBlock mt-3.5 flex items-center justify-start space-x-2 sm:justify-center md:justify-start" data-v-6d5fe847>
                                            ...
                                            echo "";
                                            //
                                            //                                            var_dump(strlen($pack['description']));
                                            echo "</pre>";
                                            ?>


                                            <!--                                 <p class="my-5 text-[15px] leading-[22px] text-black dark:text-[#b7b7b7] myTagP" data-v-6d5fe847>-->
                                            <?=$short_link = substr($pack['description'], 0, 150);?>
                                            ...
                                            //}
                                            ?>
                                            <div class="mt-6 flex items-center space-x-6 sm:justify-center md:justify-start BottomFlex" data-v-6d5fe847>
                                                <a href="<?=Url::to(['site/pack'])?>/<?=$pack['id']?>" class="btn-white2" data-v-6d5fe847>Browse Pack</a>
                                                <span style='font-weight:bold; font-size:24px;'><?php echo $pricePack.' $'; ?></span> <span class="hidden" data-v-6d5fe847></span>
    ...
    <div class="swiper-pagination"></div> -->
                    ...
                    <div>
                        <div class="swiper-button-next mySwipNext dark:colBlack"></div>
                        <div class="swiper-button-prev mySwipPrev dark:colBlack "></div>
            ...
            <!--<div class="absolute inset-0 top-[132px]" style="background:radial-gradient(44.46% 43.47% at 50% 0%, rgba(17, 17, 17, 0.4) 0%, #111111 100%), linear-gradient(180deg, transparent 0%, rgba(12, 81, 91, 0) 71.43%);"></div>-->
                        ...
                        <section class="mt-[60px] h-full overflow-y-auto overscroll-none px-4 pt-5 pb-24 text-[17px] leading-[22px]" data-v-6915f321>
                            <div data-v-6915f321>
                                ...
                                <ul class="mt-4 dark:text-white myItemFlex" data-v-6915f321>
                                    ...
                                    <!--<li data-v-6915f321>
                                    <a href="<?=Url::to(['site/samples'])?>" class="flex items-center space-x-2.5 whitespace-nowrap rounded-full px-4 py-2.5 hover:bg-black/[0.08] dark:hover:bg-white/[0.16]" data-v-6915f321>
                                       <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4" data-v-6915f321>
                                       ...
                                       <span class="flex-grow" data-v-6915f321>Samples</span>
                                    </a>
                                 </li>-->
                                    <li data-v-6915f321>
                                    ...
                                    <!-- <li data-v-6915f321>
                                    <a href="<?=Url::to(['site/creators'])?>" class="flex items-center space-x-2.5 whitespace-nowrap rounded-full px-4 py-2.5 hover:bg-black/[0.08] dark:hover:bg-white/[0.16]" data-v-6915f321>
                                       ...
                                       <span class="flex-grow" data-v-6915f321>Creators</span>
                                    </a>
                                 </li> -->
                                    <!--<li data-v-6915f321>
                                    <a href="<?=Url::to(['site/samples'])?>?type=MID" class="flex items-center space-x-2.5 whitespace-nowrap rounded-full px-4 py-2.5 hover:bg-black/[0.08] dark:hover:bg-white/[0.16]" data-v-6915f321>
                                       <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4" data-v-6915f321>
                                       ...
                                       <span class="flex-grow" data-v-6915f321>MIDI</span>
                                    </a>
                                 </li>-->
                                    <li data-v-6915f321>
                            ...
                            <div data-v-6915f321>
                                ...
                                <!-- <ul class="mt-4 space-y-3" data-v-6915f321>
                                <?php if(Yii::$app->user->isGuest):?>

                                 <li data-v-6915f321><button type="button" class="show_modal_sign_in btn_create_account block w-full rounded-full px-5 py-[11px] text-[15px] font-medium text-white bg-[#f05025]/[0.84] dark:bg-[#f05025]" data-v-6915f321>
                                    Create account
                                    </button>
                                 </li>
                                 <?php else : ?>
...
<div id="p_prldr"><div class="contpre"><span class="svg_anm"></span><br>Wait<br><small>loading</small></div></div>
