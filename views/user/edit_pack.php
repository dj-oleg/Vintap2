...
use yii\helpers\Url;
$this->title = 'Vintapes - startselling';
               ...
               <ul data-v-15fa41d2="">
                  ...
                  <li data-v-15fa41d2="">
                     <a href="<?=Url::to(['user/account'])?>" class="nuxt-link-active" data-v-15fa41d2="">
                        ...
                        <div data-v-15fa41d2="">
<!--                            <div>Withdrawals are made once a month from the 1st to the 3rd day of each month.</div>-->
...
<!--------------------------------------------------------------------->
<div data-v-066bcea0="" class="mt-4 sm:mt-8">
   <div data-v-066bcea0="" class="flex flex-wrap lg:flex-nowrap">
      <div data-v-066bcea0="">
         <div data-v-066bcea0="" class="h-[124px] w-[124px] max-w-full shrink-0 lg:h-[248px] lg:w-[248px]">
            <div data-v-066bcea0="" class="group relative h-full w-full overflow-hidden rounded-lg border border-black/[0.08]">
               <img data-v-066bcea0="" alt="" class="img_pack h-full w-full shrink-0 object-cover" src="<?=Yii::$app->request->baseUrl?>/modx/<?=(isset($pack['img']))?$pack['img']:'images/packs/noimage.jpg'?>">
               <div data-v-066bcea0="" class="show_modal_change_avatar absolute top-0 left-0 flex h-full w-full items-center justify-center bg-black bg-opacity-60 text-white transition-opacity group-hover:opacity-100 opacity-0">
                  <div class="text-center">
                     ...
                     <p class="mt-3 w-full text-xs font-bold">SET PACK THUMBNAIL</p>
                  </div>
                  <input type="file" accept="image/*" class="avtarload absolute top-0 left-0 z-10 h-full w-full cursor-pointer opacity-0">
               </div>
            </div>
         </div>
         <p data-v-066bcea0="" class="mt-2 text-xs opacity-50">PNG/JPG only. Maximum size 2MB.</p>
      </div>
      <div data-v-066bcea0="" class="mt-5 w-full lg:mt-0 lg:ml-12 lg:w-auto">
         <div data-v-066bcea0="" class="flex items-center">
            <h1 data-v-066bcea0="" class="mr-2 text-[33px] font-medium leading-10 page-title"><?=$pack['title']?></h1>

         </div>
         <div data-v-066bcea0="" class="mt-2 flex items-center">
            <div data-v-066bcea0="" class="mr-5 flex items-center">
               <svg data-v-066bcea0="" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-1.5 h-3.5 w-3.5">
               ...
               <span class="hover:underline page-genre"><?=(isset($pack['genre']))?implode(', ', explode('||',$pack['genre'])):'' ?></span> <!---->
            </div>
            <p data-v-066bcea0="" class="mr-6 opacity-50 page-price">$<?=$pack['price']?></p>
            <button data-v-066bcea0="" type="button" class="btn_edit_pack  btn-white2">Edit pack details</button><!--underline hover:no-underline-->
         </div>
         <div data-v-066bcea0="" class="mt-4 sm:max-w-[368px]">
            <span data-v-066bcea0="" class="inline text-[#5C5C5C] dark:text-[#B7B7B7] page-description"><?=$pack['description']?></span>
         </div>
         <div data-v-066bcea0="" class="mt-5 flex flex-wrap items-center">

            <!---->
         </div>
      </div>
   </div>
   <div data-v-3d6425d9="" data-v-066bcea0="" class="modal_edit_pack fixed inset-0 z-60 h-full w-full overflow-x-hidden bg-black bg-opacity-80 dark:bg-[#2c2c2c] dark:bg-opacity-70 hidden overflow-y-auto">
      <div class="animated modal-popup-container absolute inset-0 h-full w-full text-center px-3">
         <div class="inline-block w-full text-left align-middle">
            <div class="relative mx-auto max-w-full rounded-2xl bg-white px-7 pt-7 pb-9 text-black shadow-lg dark:bg-121212 dark:text-white my-8" style="width: 460px;">
               <button class="close_edit_pack text-primary absolute top-2.5 right-2.5 z-10 flex h-10 w-10 items-center justify-center opacity-100 hover:opacity-70">
               ...
               <div data-v-3d6425d9="" class="sm:px-9 sm:pt-5">
                  <h3 data-v-3d6425d9="" class="mb-8 text-center text-2xl font-medium ">Edit pack details</h3>
                  <!--<form method="post" action="<?=Url::to(['user/edit_pack'])?>/<?=$pack['id']?>">-->
                    <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                    <input type="hidden" name="type_pack" value="<?=$pack['type']?>">
                     <div data-v-3d6425d9="" class="grid grid-cols-1 gap-4">
                        <div data-v-3d6425d9="">
                          <input type="text" placeholder="Pack title" data-v-15abc323 name="title" class="form-field" value="<?=$pack['title']?>" required>
                        </div>
                        <div data-v-3d6425d9="">
                           <textarea id="editor" rows="5" placeholder="Description" data-v-15abc323 name="description" class="form-field" ><?=$pack['description']?></textarea>
                        </div>
                        <?php if($pack['type']=='sound'):?>
                        <div data-v-3d6425d9="">
                          <p class="mt-2 opacity-80">Genre:</p>
                          <?php $genres=(isset($pack['genre']))?explode('||',$pack['genre']):[]; ?>
                          <select class="js-example-basic-multiple form-field" name="genres[]" multiple="multiple" data-placeholder="Select instruments">
                            <option <?=(in_array("Hip Hop", $genres))?'selected':''?> value="Hip Hop">Hip Hop</option>
                            <option <?=(in_array("Trap", $genres))?'selected':''?> value="Trap">Trap</option>
                            <option <?=(in_array("Pop", $genres))?'selected':''?> value="Pop">Pop</option>
                            <option <?=(in_array("Soul & R&B", $genres))?'selected':''?> value="Soul & R&B">Soul & R&B</option>
                            <option <?=(in_array("Rock", $genres))?'selected':''?> value="Rock">Rock</option>
                            <option <?=(in_array("Drill", $genres))?'selected':''?> value="Drill">Drill</option>
                            <option <?=(in_array("Electronic", $genres))?'selected':''?> value="Electronic">Electronic</option>
                            <option <?=(in_array("Afrobeat", $genres))?'selected':''?> value="Afrobeat">Afrobeat</option>
                            <option <?=(in_array("Latin", $genres))?'selected':''?> value="Latin">Latin</option>
                            <option <?=(in_array("Funk", $genres))?'selected':''?> value="Funk">Funk</option>
                            <option <?=(in_array("Cinematic", $genres))?'selected':''?> value="Cinematic">Cinematic</option>
                            <option <?=(in_array("Lofi", $genres))?'selected':''?> value="Lofi">Lofi</option>
                            <option <?=(in_array("Hyperpop", $genres))?'selected':''?> value="Hyperpop">Hyperpop</option>
                            <option <?=(in_array("Country", $genres))?'selected':''?> value="Country">Country</option>
                            <option <?=(in_array("World", $genres))?'selected':''?> value="World">World</option>
                            <option <?=(in_array("Indie", $genres))?'selected':''?> value="Indie">Indie</option>
                            <option <?=(in_array("Folk", $genres))?'selected':''?> value="Folk">Folk</option>
                            <option <?=(in_array("Reggae", $genres))?'selected':''?> value="Reggae">Reggae</option>
                          </select>
                        </div>
                        <div data-v-3d6425d9="">
                          <p class="mt-3 opacity-80">Instruments:</p>
                          <?php $instruments=(isset($pack['instrument']))?explode('||', $pack['instrument']):[];?>
                          <select class="js-example-basic-multiple form-field" name="instruments[]" multiple="multiple" data-placeholder="Select an genre">
                             <option <?=(in_array("Drums", $instruments))?'selected':''?> value="Drums">Drums</option>
                             <option <?=(in_array("Guitar", $instruments))?'selected':''?> value="Guitar">Guitar</option>
                             <option <?=(in_array("Keys", $instruments))?'selected':''?> value="Keys">Keys</option>
                             <option <?=(in_array("Vocals", $instruments))?'selected':''?> value="Vocals">Vocals</option>
                             <option <?=(in_array("Synth", $instruments))?'selected':''?> value="Synth">Synth</option>
                             <option <?=(in_array("Pads", $instruments))?'selected':''?> value="Pads">Pads</option>
                             <option <?=(in_array("Pluck", $instruments))?'selected':''?> value="Pluck">Pluck</option>
                             <option <?=(in_array("String", $instruments))?'selected':''?> value="String">String</option>
                             <option <?=(in_array("Bass", $instruments))?'selected':''?> value="Bass">Bass</option>
                             <option  <?=(in_array("Percussion", $instruments))?'selected':''?> value="Percussion">Percussion</option>
                             <option  <?=(in_array("Horns & Flutes", $instruments))?'selected':''?> value="Horns & Flutes">Horns & Flutes</option>
                             <option  <?=(in_array("FX", $instruments))?'selected':''?> value="FX">FX</option>
                             <option  <?=(in_array("Vintage", $instruments))?'selected':''?> value="Vintage">Vintage</option>
                             <option  <?=(in_array("Full Composition", $instruments))?'selected':''?> value="Full Composition">Full Composition</option>
                          </select>
                        </div>
                      <?php endif;?>
                        <div data-v-3d6425d9="">
                        <p class="opacity-80 mt-2">Price:</p>
                        <input type="number" class="form-field price" name="price" lang="en" step="0.01" value="<?=intval($pack['price'])?>" min="0">
                      </div>
                      <?php if($pack['type']=='sound'):?>
                      <div data-v-3d6425d9="">
                        <p class="opacity-80 mt-3">Count samples:</p>
                        <input type="number" class="form-field price" name="count_songs" step="1" value="<?=intval($pack['count_songs'])?>" min="1">
                      </div>
                      <?php endif;?>
                        <!---->
                     </div>
                     ...
                     <span class="btn" id="btn-coloboration">Add co-author</span>
                     <?php endif; ?>
                     <div data-v-3d6425d9="" class="div-coloboration" style="<?=(isset($pack['coloborant']))?'display:block':''?>">
                        <p class="opacity-80 mt-3">co-author:</p>
                        <input value="<?=(isset($pack['coloborant']))?$pack['coloborant']:''?>" type="text" class="form-field input-coloboration"  name="coloboration" placeholder="second creators emeil" >
                        <p class="rezult-coloboration"></p>
                     </div>
                     <input value="<?=(isset($pack['id_user_coloborant']))?$pack['id_user_coloborant']:''?>" type="hidden" name="id_coloborant" class="id-coloborant">
                     <div data-v-3d6425d9="" class="mt-10 text-center">
                        <button data-v-3d6425d9="" class="btn-purple" type="submit">
                           <span class="spin w-4">
                           ...
                           <span class="save-changes close_edit_pack">Save changes</span>
                        </button>
                     </div>
                  <!--</form>-->
               </div>
   ...
   <div data-v-066bcea0="" class="mt-8 mb-5 h-px bg-black bg-opacity-[0.12] dark:bg-white dark:bg-opacity-[0.12]"></div>
</div>
<!-------------------------------------------------------------------->
<div data-fetch-key="data-v-01c545b2:0" data-v-01c545b2="" data-v-066bcea0="">
   <div class="overflow-y-auto" data-v-01c545b2="">
      <table class="account-table" data-v-01c545b2="">
         <thead data-v-01c545b2="">
            <tr data-v-01c545b2="">
               <th class="!pl-0" data-v-01c545b2="">
                  <div class="text-2xl font-bold" data-v-01c545b2="">
                     Files <span class="text-xl text-[#7C7C7C]" data-v-01c545b2="">
                       <?php if(isset($pack['img_files'])):?>
                          <?php $all_images = (array)json_decode($pack['img_files']); //echo3($all_images); ?>
                                <?=count($all_images)?>
                      <?php endif; ?>
                       <?=($pack['type']=='sound')?intval($pack['count_songs']):''?>
                     </span>
                  </div>
               </th>
               <!--<th class="text-center" data-v-01c545b2="">Upload date</th>-->
               <th class="w-px" data-v-01c545b2="">Type</th>
            </tr>
         </thead>
         <tbody data-v-01c545b2="">
           <?php if($pack['type']=='sound'):?>
            <tr data-v-01c545b2="">
               <td data-v-01c545b2="">
                  <div class="flex items-center" data-v-01c545b2="">
                     <div class="h-8 w-8 overflow-hidden rounded border border-black/[0.08] dark:border-white/[0.08]" data-v-01c545b2="">
                       <?php if($pack['audio_file']!=""):?><img alt="" src="<?=Yii::$app->request->baseUrl?>/modx/<?=(isset($pack['img']))?$pack['img']:'images/packs/noimage.jpg'?>" class="img_pack h-full w-full shrink-0 object-cover" data-v-01c545b2=""><?php endif;?>
                     </div>
                     <span class="ml-3 xl:max-w-[300px] xl:truncate" data-v-01c545b2=""><?=($pack['audio_file']!="")?explode("/", $pack['audio_file'])[count(explode("/", $pack['audio_file']))-1]:"No file"?></span> <!---->
                  </div>
               </td>
                <!--<td class="text-center" data-v-01c545b2="">2/3/2023</td>-->
               <td class="whitespace-nowrap" data-v-01c545b2="">
                  <div class="flex items-center" data-v-01c545b2="">
                     <span class="active-status mr-2.5" data-v-01c545b2="">Sound preview</span>
                     <div class="opacity-50 hover:opacity-80" data-v-01c545b2="" style="margin-left: auto;margin-right: 0;">
                        <a href="<?=Url::to(['upload/upload','id'=>$pack['id'],'type'=>'preview'])?>" class="grid h-5 w-5 place-content-center overflow-hidden rounded-full bg-black/[0.15] dark:bg-white/[0.15]" data-v-01c545b2="">
          ...
          <?php endif; ?>
            <tr data-v-01c545b2="">
               <td data-v-01c545b2="">
                  <div class="flex items-center" data-v-01c545b2="">
                     <div class="h-8 w-8 overflow-hidden rounded border border-black/[0.08] dark:border-white/[0.08]" data-v-01c545b2="">
                       <?php if($pack['zip_file']!=""):?><img alt="" src="<?=Yii::$app->request->baseUrl?>/modx/<?=(isset($pack['img']))?$pack['img']:'images/packs/noimage.jpg'?>" class="img_pack h-full w-full shrink-0 object-cover" data-v-01c545b2=""><?php endif;?>
                       </div>
                     <span class="ml-3 xl:max-w-[300px] xl:truncate" data-v-01c545b2=""><?=($pack['zip_file']!="")?explode("/", $pack['zip_file'])[count(explode("/", $pack['zip_file']))-1]:"No file"?></span> <!---->
                  </div>
               </td>
               <!--<td class="text-center" data-v-01c545b2="">2/3/2023</td>-->
               <td class="whitespace-nowrap" data-v-01c545b2="">
                  <div class="flex items-center" data-v-01c545b2="">
                     <span class="active-status mr-2.5" data-v-01c545b2="">Zip-file</span>
                     <div class="opacity-50 hover:opacity-80" data-v-01c545b2="" style="margin-left: auto;margin-right: 0;">
                        <!--<a href="<?=Url::to(['upload/upload','id'=>$pack['id'],'type'=>'zip'])?>" class="grid h-5 w-5 place-content-center overflow-hidden rounded-full bg-black/[0.15] dark:bg-white/[0.15]" data-v-01c545b2="">-->
                        <button class="btn_upload grid h-5 w-5 place-content-center overflow-hidden rounded-full bg-black/[0.15] dark:bg-white/[0.15]" data-v-01c545b2="">   
                        <i class="fa-solid fa-pen-to-square"></i>
                        </button>
                        <!--</a>-->
                     </div>
            ...
            <!---->
            <?php if($pack['type']=='img'):?>
              <?php if (isset($all_images)): ?>
              <?php foreach($all_images as $key => $image): ?>

             <tr class="tr_img_<?=$key?>" data-v-01c545b2="">
                <td data-v-01c545b2="">
                   <div class="flex items-center" data-v-01c545b2="">
                      <div class="h-8 w-8 overflow-hidden rounded border border-black/[0.08] dark:border-white/[0.08]" data-v-01c545b2="">
                        <?php if (isset($image->image_preview)):?><img alt="" src="<?=str_replace(" ", '%20', Yii::$app->request->baseUrl.'/modx/'.$image->image_preview)?>" class="btn_add_sample img_pack h-full w-full shrink-0 object-cover" data-v-01c545b2="" img="<?=str_replace(" ", '%20', Yii::$app->request->baseUrl.'/modx/'.$image->image_preview)?>"><?php endif;?>
                      </div>
                      <span class="ml-3 xl:max-w-[300px] xl:truncate" data-v-01c545b2=""><?=($image->image_preview!="")?explode("/", $image->image_preview)[count(explode("/", $image->image_preview))-1]:"No file"?></span> <!---->
                   </div>
                </td>
                 <!--<td class="text-center" data-v-01c545b2="">2/3/2023</td>-->
                <td class="whitespace-nowrap" data-v-01c545b2="">
                   <div class="flex items-center" data-v-01c545b2="">
                      <span class="active-status mr-2.5" data-v-01c545b2="">Image preview</span>
                      <div class="opacity-50 hover:opacity-80" data-v-01c545b2="" style="margin-left: auto;margin-right: 0;">
                         <button id_img="<?=$key?>" class="del_img btn_add_sample img_pack grid h-5 w-5 place-content-center overflow-hidden rounded-full bg-black/[0.15] dark:bg-white/[0.15]" data-v-01c545b2="" img="<?=str_replace(" ", '%20', Yii::$app->request->baseUrl.'/modx/'.$image->image_preview)?>">
                            <i class="fa-solid fa-trash del_img btn_add_sample" d_img="<?=$key?>" img="<?=str_replace(" ", '%20', Yii::$app->request->baseUrl.'/modx/'.$image->image_preview)?>"></i>
                         </button>
                      </div>
                   </div>
                </td>
              ...
              <tr data-v-01c545b2="">
                 <td data-v-01c545b2="">
                    <div class="flex items-center" data-v-01c545b2="">
                       ...
                       <span class="ml-3 xl:max-w-[300px] xl:truncate" data-v-01c545b2="">Add new files</span> <!---->
                    </div>
                 </td>
                  <!--<td class="text-center" data-v-01c545b2="">2/3/2023</td>-->
                 <td class="whitespace-nowrap" data-v-01c545b2="">
                    <div class="flex items-center" data-v-01c545b2="">
                       <span class="active-status mr-2.5" data-v-01c545b2="">Image preview</span>
                       <div class="opacity-50 hover:opacity-80" data-v-01c545b2="" style="margin-left: auto;margin-right: 0;">
                          <a href="<?=Url::to(['user/upload2','id'=>$pack['id'],'type'=>'img'])?>" class="grid h-5 w-5 place-content-center overflow-hidden rounded-full bg-black/[0.15] dark:bg-white/[0.15]" data-v-01c545b2="">
   ...
   <div class="animated modal-popup-container absolute inset-0 h-full w-full text-center px-3">
      <div class="inline-block w-full text-left align-middle">
         <div id="modal_change_avatar" class="relative mx-auto max-w-full rounded-2xl bg-white px-7 pt-7 pb-9 text-black shadow-lg dark:bg-121212 dark:text-white my-8" style="width: 788px;">
            <button type="button" class="hide_modal_change_avatar text-primary absolute top-2.5 right-2.5 z-10 flex h-10 w-10 items-center justify-center opacity-100 hover:opacity-70">
               <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="w-5">
                  <g>
                     <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2px" x1="7" x2="25" y1="7" y2="25" class="cls-1"></line>
                     <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2px" x1="7" x2="25" y1="25" y2="7" class="cls-1"></line>
            ...
            <div>
               <h3 class="mb-10 text-center text-2xl font-medium">Set pack image</h3>
               <div>

                  <center><div class="image-wrapper" id="image-4-wrapper" >
                    <img id="image-4"  src="/img/load.gif" alt="profile picture" style="width: 732px;">
                  </div></center>
   ...
   <div class="animated modal-popup-container2 absolute inset-0 h-full w-full text-center px-3">
      <div class="inline-block w-full text-left align-middle">
         <div id="modal_add_sample" class="relative mx-auto max-w-full rounded-2xl bg-white px-7 pt-7 pb-9 text-black shadow-lg dark:bg-121212 dark:text-white my-8" style="width: 760px;">
            <button type="button" class="hide_modal_add_sample text-primary absolute top-2.5 right-2.5 z-10 flex h-10 w-10 items-center justify-center opacity-100 hover:opacity-70">
               <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="w-5">
                  <g>
                     <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2px" x1="7" x2="25" y1="7" y2="25" class="cls-1"></line>
                     <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2px" x1="7" x2="25" y1="25" y2="7" class="cls-1"></line>
              ...
              <div>
                 <h3 class="del_img_header mb-10 text-center text-2xl font-medium">Image preview</h3>
                 <div>
<div class="del_img_div text-center mb-10 hidden">
  <h4 class="text-center text-2xl font-medium">Are you sure you want to delete this image preview?</h4><br>
  <button class="btn-purple text-center btn_del_img_yes ">Yes</button>
  <button class="btn-purple hide_modal_add_sample" style="background-color:#e17055;margin-left:10px">No</button>
</div>
                    <center><div class="image-wrapper" id="image-4-wrapper" >
                      <img id="image-preview"  src="https://vintapes.com/modx/images/pack/133/001girl.jpg" alt="profile picture" style="width: 732px;">
                    </div></center>
...
<!------------------------upload--------------------->
<div id="div_upload" class="hidden fixed inset-0 z-60 h-full w-full overflow-x-hidden bg-black bg-opacity-80 dark:bg-[#2c2c2c] dark:bg-opacity-70 overflow-y-auto">
   <div class="zone3 animated modal-popup-container absolute inset-0 h-full w-full text-center px-3">
      <div class="inline-block  text-left align-middle">
         <div id="modal_upload" class="relative mx-auto max-w-full rounded-2xl bg-white px-7 pt-7 pb-9 text-black shadow-lg dark:bg-121212 dark:text-white my-8" style="width: 788px;">
            <button type="button" class="hide_modal_upload text-primary absolute top-2.5 right-2.5 z-10 flex h-10 w-10 items-center justify-center opacity-100 hover:opacity-70">
               <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="w-5">
                  <g>
                     <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2px" x1="7" x2="25" y1="7" y2="25" class="cls-1"></line>
                     <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2px" x1="7" x2="25" y1="25" y2="7" class="cls-1"></line>
            ...
            <div>
               ...
               <div class="mt-8 zone" data-v-066bcea0="">
                     <div data-v-066bcea0="">
                     <form method="post" action="<?=Url::to(['user/loadfile'])?>">
                        <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                        <input type="hidden" name="type_file" value="">
                        <input type="hidden" name="id_pack" value="<?=$pack['id']?>">
                        <div id="dropZone" class="group border border-dashed px-5 py-20 text-center hover:border-black dark:hover:border-white dz-clickable" id="dropzone">
                        <input type="file" multiple="multiple" style="position:absolute;right:0;opacity:0;font-size:100px;">
                           <div class="dz-message">
                              ...
                              <p class="zone2 mt-8 text-black dark:text-white">Drag <span class="typefile">Zip</span> to upload file from your device!</p>
                              <p class="zone2 mt-5 text-xs text-black opacity-30 dark:text-white">
                                 Maximum upload size per file is 200MB.<br>
                                 <span class="typefile">Zip</span> file format accepted only.
                              </p>
                           </div>
                        </div>
                     </form>
                        <div class="text-center text-xs zone2">
                           <!--<p class="mt-10">
                              Please read our
                              <a target="_blank" href="https://wavs.zendesk.com/hc/en-us/articles/360049330653-Guidelines-Tips-for-Sellers" class="underline hover:no-underline">Seller Handbook</a> before uploading
                           </p>
                           <p class="mt-1"><span>242</span> / 250 samples available to upload.
                           </p>-->
                        </div>
                        <div class="upload-file-list mx-auto mt-10 max-w-lg text-center zone2">
                           <div class="files space-y-2.5"></div>
                           <!---->
                           <p class="mt-8 text-xs opacity-30">Once the upload is in progress, please do not navigate away from this screen, or any pending uploads will not be completed.</p>
                        <!--<button class="btn btn_upload_change">change</button>-->
                        </div>
                     </div>
                  </div>
...
$this->registerJsFile(Yii::$app->request->baseUrl . 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js', ['depends' => [yii\web\JqueryAsset::className()]]);
//$this->registerJsFile(Yii::$app->request->baseUrl . '/dist/rcrop.min.css', ['depends' => [yii\web\JqueryAsset::className()]]);
?>
<?php
$url_del_img=Url::to(['ajax/del_img']);
$url=Url::to(['ajax/crop_image_pack']);
$url_coloboration = Url::to(['ajax/coloboration']);
$url_editpack = Url::to(['ajax/edit_pack']).'/'.$pack['id'];
$packid=$pack['id'];
if(isset($all_images)) $all_images_js=json_encode($all_images); else $all_images_js=null;
////////////////////////upload▼
$id_pack=$pack['id'];
$type_file='zip';
$url_load=Url::to(['user/loadfile']);
$url_editpack=Url::to(['user/edit_pack','id'=>$pack['id']]);
$CsrfToken=Yii::$app->request->getCsrfToken();
//////////////////////end_upload▲
$script = <<< JS
//load img preview
//$('.fileimg').change(function(event) { alert();
    //var output = $(this).parent().parent().children(img);
    //output.src = URL.createObjectURL(event.target.files[0]);
    //output.onload = function() {
    //URL.revokeObjectURL(output.src) // free memory
    //}
//)};
$('input.fileimg').change(function(event){
  //alert(event.target.files[0]);
    var output =$(this).parents().parents().children('img');
    //output.src = URL.createObjectURL(event.target.files[0]);
...
//add new samples
$("body").on("click", ".btn_add_sample", function(){
...
$(".hide_modal_add_sample") .click(function () {
    $("#div_add_sample").addClass("hidden");
    $(".modal-popup-container2").children(".inline-block").addClass("w-full");
    $(".del_img_div").addClass("hidden");
    $(".del_img_header").removeClass("hidden");
});
//
//modal change avatar
//
...
/*$(document).click(function (e) {
  if(!$(e.target).closest('#modal_change_avatar').length && !$(e.target).is('#modal_change_avatar')&& !$(e.target).is('.show_modal_change_avatar')) {
    ...
    $("#image-4").rcrop('destroy');
    $("#image-4").attr("src",'/img/load.gif');
 }
});*/
...
$("#crop").click(function(){
    ...
    var srcOriginal = $("#image-4").rcrop('getDataURL',225,225);
    $(".img_pack").attr('src',srcOriginal);
    $.ajax({
        type: "POST",
        url: '$url',
        data: {img_url: srcOriginal, pack_id: $packid}
        });
...
//превью картинки
$("body").on("input", ".fileimgpr", function(e){
	//$(this).parent().parent().parent().css("borderColor","#ccc");
	var files = e.target.files;
	var images =$(".all_images_preview");
	var kol_img =$(".kol_img");
  //var count_old = $('.newimg').length;
  $('.newimg').remove();
  //var my_id=1;
  //var my_id =$(this).parent().parent().siblings(".my_id").val();

	//$(this).parent().parent().parent().prepend('<div class="btn btn-primary btn-xs"><label><input type="file" class="fileMulti" name="fileMulti[]" multiple style="display: none;"accept="image/jpeg,image/png,image/gif,image/tiff,image/tiff,image/x-tiff,application/x-compressed,application/x-gzip,application/x-gzip,multipart/x-gzip,application/x-compressed,application/x-compressed,application/x-zip-compressed,application/zip,multipart/x-zip,application/x-rar-compressed,.rar">Прикрепить файлы</label></div>');
	//$(this).parent().parent().hide();
	for (var i = 0, file; file = files[i]; i++) {
		//images.html('');
		var rash=file.name.split(".").pop();
		if ((file.type.match('image.*'))||
		...
		reader.onload = (function(event) {
			...
			if(event.type.match('image.*'))
				images.append('<div class="newimg group swiper-slide w-1/6 shrink-0 focus:outline-none px-3"><div class="relative overflow-hidden rounded bg-black bg-opacity-10"><div class="pointer-events-none absolute inset-0 flex h-full w-full items-center justify-center bg-black bg-opacity-40 text-white transition-opacity focus:outline-none group-hover:opacity-100 opacity-0"></div><span class="hidden"></span> <span class="btn_add_sample block h-0 w-full bg-cover bg-center" style="padding-bottom:100%;background-image:url('+e.target.result+');" img="'+e.target.result+'"></span><div class="absolute bottom-1 left-1 hidden items-center rounded-[5px] bg-black/[0.48] px-1 py-[5px] text-xs text-white backdrop-blur-lg sm:inline-flex" style="padding:2px 7px; background-color: rgba(33, 150, 243, 0.6);">new</div></div></div>');
			};
		})(file);
		reader.readAsDataURL(file);
  } else { alert('File must be imaages. File '+ file.name +' will not loaded.'); }
	//kol_img.val(i+1);
	}
	kol_img.html(i);
  $('.kol_file').html(i>1 ? ' files' : ' file');
});

////////////////////////////
$('.btn_edit_pack').click(function () {
    $(".modal_edit_pack").removeClass("hidden");
    $(".modal_edit_pack").find(".inline-block").removeClass("w-full");
});
$('.close_edit_pack').click(function () {
    $(".modal_edit_pack").addClass("hidden");
    $(".modal_edit_pack").find(".inline-block").addClass("w-full");
});
///////////////////////////
$('.del_img').click(function () {
  var id_img = $(this).attr('id_img');
  $(".del_img_div").removeClass("hidden");
  $(".del_img_header").addClass("hidden");
  $(".btn_del_img_yes").attr('id_img', id_img);
});
$('.btn_del_img_yes').click(function () {
  var id_img = $(this).attr('id_img');
  $.ajax({
        method: "POST",
        url: '$url_del_img',
        data: { id_img: id_img,
                id_pack: $packid,
                all_images_js:JSON.stringify($all_images_js)
              }
      })
        .done(function( rez ) {
          //alert( "rez: " + rez );
...
///////////////////////////
$('input.filesound').change(function(){
            var value = $(this).val();
            arrayOfStrings = value.split('\\\');
            $(this).parents().children("i").html(arrayOfStrings[arrayOfStrings.length-1]);
        });

//btn-coloboration
$("#btn-coloboration").click(function(){
    $(".div-coloboration").show();
});
    
$('input.input-coloboration').on('input',function(e){
    var email = $(this).val();
    if (email.length>3)
    $.ajax({
            method: "POST",
            url: '$url_coloboration',
            data: { email: email }
      })
        .done(function( rez ) {
            if(rez>0) {
                $(".rezult-coloboration").css('color','green');
                $(".rezult-coloboration").html('user found');
                $(".id-coloborant").val(rez);
            }else{
                $(".rezult-coloboration").css('color','red');
                $(".rezult-coloboration").html('no user found');
                $(".id-coloborant").val(rez);
            }
        });
});
...
$('.save-changes').click(function () {
    var type_pack = $("input[name='type_pack']").val();
    var title = $("input[name='title']").val();
    var description = editor.getData();// ClassicEditor.instances['editor'].getData();
    var id_coloborant = $("input[name='id_coloborant']").val();
    var price = $("input[name='price']").val();
    var count_songs = $("input[name='count_songs']").val();
    var genres = $("select[name='genres[]']").val();
    var instruments = $("select[name='instruments[]']").val();
    $.ajax({
      method: "POST",
      url: '$url_editpack',
      data: { type_pack: type_pack
            ,title:title
            ,description:description
            ,id_coloborant:id_coloborant
            ,price:price
      ...
      .done(function( rez ) {
         ...
         $(".page-genre").html(genres);
         $(".page-price").html('$'+price);
...
//$(".btn_add_sample").click(function(){
  $("#div_upload").removeClass("hidden");
});
/*$(document).click(function (e) {
  if(!$(e.target).closest('#modal_upload').length && !$(e.target).is('#modal_upload')&& !$(e.target).is('.btn_upload')) {
    $("#div_upload").addClass("hidden");
 }
});*/
$(".hide_modal_upload") .click(function () {
    $("#div_upload").addClass("hidden");
});
///////////////////////////////////////
///////////upload script▼
  ...
  console.log(event);
    if (event.target.readyState == 4) {
        if (event.target.status == 200) {
            dropZone.html('<p>Upload completed successfully!</p>');
        } else {
            dropZone.text('Error!');
            dropZone.addClass('error');
        }
...
///////////end upload script▲
function change_upload_window(){
   //$('#div_upload').hide();
   $('#modal_upload').css("height","100px");
   $('#modal_upload').css("width","250px");
   //$('#modal_upload').css("padding","0px");
   $('#modal_upload').css("margin","0px");
   $('#dropZone').css("padding","30px 0 0 0");
   $('#dropZone').css("height","80px");
   $('#dropZone').css("width","230px");
   $('.zone').css("width","230px");
   $('.zone').css("height","80px");
   $('.zone').css("margin-top","-17px");
   $('.zone').css("margin-left","-17px");
   $('.zone2').hide();
   $('#div_upload').css("bottom","5px");
   $('#div_upload').css("right","5px");
   $('#div_upload').css("height","100px");
   $('#div_upload').css("width","250px");
   $('#div_upload').css("position","fixed");
   $('#div_upload').css("margin","0px");
   $('#div_upload').removeClass('inset-0');
   $('.zone3').removeClass('animated modal-popup-container absolute inset-0 h-full w-full text-center px-3');

}
$("body").on("click", ".btn_upload_change", function(){
   change_upload_window();
});
/*$('input.input-coloboration').change(function(){
            var email = $(this).val();
            $.ajax({
            method: "POST",
            url: '$url_coloboration',
...
<style>
  ...
  .btn_add_sample{cursor:pointer}
  .account-table[data-v-01c545b2] {
    min-width: 100%;
    border-collapse: collapse;
    text-align: left
  }

  .account-table thead tr th[data-v-01c545b2] {
    white-space: nowrap;
  ...
  .account-table tbody tr td[data-v-01c545b2] {
    padding: .5rem 1.25rem
  }

  .account-table tbody tr[data-v-01c545b2] {
    --tw-text-opacity: 1;
    color: rgb(92 92 92/var(--tw-text-opacity))
  }

  .dark .account-table tbody tr[data-v-01c545b2] {
    --tw-text-opacity: 1;
    color: rgb(183 183 183/var(--tw-text-opacity))
  }

  .account-table tbody tr:nth-child(odd) td[data-v-01c545b2] {
    background-color: rgb(0 0 0/.04)
  }

  .dark .account-table tbody tr:nth-child(odd) td[data-v-01c545b2] {
    background-color: rgb(255 255 255/.04)
  }

  .account-table tbody tr:nth-child(odd) td[data-v-01c545b2]:first-child {
    border-top-left-radius: .5rem;
    border-bottom-left-radius: .5rem
  }

  .account-table tbody tr:nth-child(odd) td[data-v-01c545b2]:last-child {
