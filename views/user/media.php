   ...
   <div class="w-full">
      <div class="-mt-7 md:mt-0" data-v-15fa41d2="">
         ...
         <div class="w-full md:pl-64 lg:pl-80" data-v-15fa41d2="">
            <div data-v-15fa41d2="">
              <?php if($user->attribut->website=='' or $user->attribut->website==null): ?>
                <div class="alert alert-danger" role="alert">
                  You have to fill out your paypal email to receive payments
                </div>
              <?php endif; ?>
...
<!!!!!!!!!!---------------------------------->
<div class="mt-11 grid grid-cols-2 gap-x-[18px] gap-y-8 lg:grid-cols-3 xl:grid-cols-4">
  <div  class="opacity-30 hover:opacity-100 dark:opacity-70 dark:hover:opacity-100">
     <div id="btn_add_pack" class="relative h-0 w-full cursor-pointer rounded-lg border border-dashed border-5c5c5c dark:border-b7b7b7" style="padding-bottom: 100%;">
        <p class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform">
           <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-5c5c5c dark:text-b7b7b7">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M15 0C16.1835 0 17.1429 0.95939 17.1429 2.14286V27.8571C17.1429 29.0406 16.1835 30 15 30C13.8165 30 12.8571 29.0406 12.8571 27.8571V2.14286C12.8571 0.95939 13.8165 0 15 0Z" fill="currentColor"></path>
              <path fill-rule="evenodd" clip-rule="evenodd" d="M30 15C30 16.1835 29.0406 17.1429 27.8571 17.1429L2.14286 17.1429C0.959389 17.1429 -3.44873e-08 16.1835 0 15C3.44873e-08 13.8165 0.959389 12.8571 2.14286 12.8571L27.8571 12.8571C29.0406 12.8571 30 13.8165 30 15Z" fill="currentColor"></path>
           </svg>
        </p>
     </div>
  </div>
  ...
  <?php foreach($packs_creator as $pack): ?>
   <div class="group">
      <div class="relative overflow-hidden rounded-lg border border-black/[0.08] dark:border-white/[0.08]">
         <span class="absolute top-2 left-2 rounded bg-black/80 py-0.5 px-1 text-xs text-white"></span>
         <button onclick="remPack(this,<?=$pack['id']?>)" class="absolute top-0 right-0 p-2 text-red-700 hover:text-red-800">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="w-5">
               <g opacity="1">
                  <path d="M16.1042 7.89062C16.1042 7.89062 15.6517 13.5031 15.3892 15.8673C15.2642 16.9965 14.5667 17.6581 13.4242 17.679C11.25 17.7181 9.07332 17.7206 6.89999 17.6748C5.80082 17.6523 5.11499 16.9823 4.99249 15.8731C4.72832 13.4881 4.27832 7.89062 4.27832 7.89062" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                  <path d="M17.2567 5.19987H3.125" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                  <path d="M14.5335 5.20047C13.8793 5.20047 13.316 4.73797 13.1877 4.09714L12.9852 3.0838C12.8602 2.6163 12.4368 2.29297 11.9543 2.29297H8.42682C7.94432 2.29297 7.52099 2.6163 7.39599 3.0838L7.19349 4.09714C7.06516 4.73797 6.50182 5.20047 5.84766 5.20047" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
               </g>
            </svg>
         </button>
         <a href="<?=Url::to(['user/edit_pack'])?>/<?=$pack['id']?>" class="block h-0 bg-cover bg-center" style="padding-bottom: 100%; background-image: url(&quot;<?=Yii::$app->request->baseUrl?>/modx/<?=$pack['img']?>&quot;);"></a>
      </div>
      <div class="mt-3 flex">
         <a href="<?=Url::to(['user/edit_pack'])?>/<?=$pack['id']?>" class="truncate hover:underline"><?=$pack['title']?></a>
         <div class="ml-auto flex items-center text-xs">
            <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4">
               <g>
                  <path d="M4,20a1,1,0,0,1-1-1V13a1,1,0,0,1,2,0v6A1,1,0,0,1,4,20Z"></path>
                  <path d="M8,23a1,1,0,0,1-1-1V10a1,1,0,0,1,2,0V22A1,1,0,0,1,8,23Z"></path>
                  <path d="M12,20a1,1,0,0,1-1-1V13a1,1,0,0,1,2,0v6A1,1,0,0,1,12,20Z"></path>
                  <path d="M16,24a1,1,0,0,1-1-1V9a1,1,0,0,1,2,0V23A1,1,0,0,1,16,24Z"></path>
                  <path d="M20,27a1,1,0,0,1-1-1V6a1,1,0,0,1,2,0V26A1,1,0,0,1,20,27Z"></path>
                  <path d="M24,23a1,1,0,0,1-1-1V10a1,1,0,0,1,2,0V22A1,1,0,0,1,24,23Z"></path>
                  <path d="M28,19a1,1,0,0,1-1-1V14a1,1,0,0,1,2,0v4A1,1,0,0,1,28,19Z"></path>
               </g>
            </svg>
            <span class="ml-2"><?=$pack['count_songs']?></span>
         </div>
      </div>
   </div>
 <?php endforeach; ?>
 ...
 <div class="animated modal-popup-container absolute inset-0 h-full w-full text-center px-3">
    <div class="inline-block w-full text-left align-middle">
       <div id="modal_add_pack" class="relative mx-auto max-w-full rounded-2xl bg-white px-7 pt-7 pb-9 text-black shadow-lg dark:bg-121212 dark:text-white my-8" style="width: 380px;">
          ...
          <div>
             <h3 class="mb-10 text-center text-2xl font-medium">Create new Pack</h3>

               <form data-v-7d749ad6="" method="post" action="<?=Url::to(['user/add_pack'])?>">
              ...
              <div>
                  <div data-v-15abc323="" class="mt-5 max-w-xs">
                   ...
                   <p class="mt-10 opacity-80">Choose the type of pack:</p>
                   <div data-v-15abc323="">

                     <input type="radio" name="type_pack" value="sound" id="sound" class="form-field" checked>
                     <label for="sound">Sound samples</label><br>
                     <input type="radio" name="type_pack" value="picture" id="picture" class="form-field">
...
$("#btn_add_pack").click(function(){
  $("#div_add_pack").removeClass("hidden");
  $(".modal-popup-container").children(".inline-block").removeClass("w-full");
});
$(document).click(function (e) {
  if(!$(e.target).closest('#modal_add_pack').length && !$(e.target).is('#modal_add_pack')&& !$(e.target).is('#btn_add_pack')) {
    $("#div_add_pack").addClass("hidden");
    $(".modal-popup-container").children(".inline-block").addClass("w-full");
 }
});
$(".hide_modal_add_pack") .click(function () {
    $("#div_add_pack").addClass("hidden");
    $(".modal-popup-container").children(".inline-block").addClass("w-full");
});
...
<!-- myScript -->
<script>
function remPack(myThis,myId){
let check = confirm("Remove thith pach?")
if (check){
   $.ajax({
    url: '/remPack',
    method: 'post',
   //  dataType: 'html',
    ...
    success: function(data){
      if(data == '1'){document.location.reload()} else{ alert("error remove")}
    }
});
}
}
