...
<div class="main-content-area mt-12 box-small" style="min-height: 500px;">
   <div data-v-6915f321="" class="block lg:hidden">
      <div data-v-6915f321="" class="fixed inset-0 z-[32] bg-[rgba(44,44,44,0.72)] lg:hidden hidden"></div>
      <div class="vue-sticky-placeholder" style="padding-top: 0px;"></div>

      <div data-v-6915f321="" sticky-offset="{ top: 105 }" sticky-z-index="38" class="sticky-nav z-20 h-screen w-full pb-8 font-circular-std lg:block lg:h-auto lg:w-56 hidden bg-white dark:bg-black pt-9 vue-sticky-el top-sticky" style="position: fixed; top: 0px; bottom: auto; left: 0px; width: 0px; z-index: 38;">
         <div data-v-6915f321="" class="fixed flex h-16 w-full max-w-[232px] items-center border-b px-8 py-[18px] dark:bg-black lg:h-24 border-black/[0.16] bg-white dark:border-white/[0.16] dark:bg-black top-9">
            <a data-v-6915f321="" href="/" class="w-full nuxt-link-active dark:text-white">
            <img id="headimg" src="<?=Yii::$app->request->baseUrl?>/img/logo_name<?=$carrent_theme=="Light"?"":"_white"?>.png" class="w-20 lg:w-24">
            </a>
            <button data-v-6915f321="" type="button" class="close-mobile-menu absolute -right-14 rounded-full bg-white">
               <svg data-v-6915f321="" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-black hover:text-[#7E8084]">
         ...
         <div data-v-15fa41d2="" class="md:float-left md:w-[228px]">
            <div data-v-15fa41d2="" class="sm:rounded-2xl sm:bg-white sm:p-5 sm:shadow-[0_0_20px_rgba(0,0,0,0.12)] sm:dark:bg-black dark:sm:shadow-[0_0_20px_rgba(0,0,0,0.48)]">
               <div data-v-15fa41d2="" class="hidden sm:block">
                  <div data-v-15fa41d2="" class="relative flex justify-center">
                     <div data-v-15fa41d2="" class="group relative h-[102px] w-[102px] shrink-0 overflow-hidden rounded-full border border-black/[0.08] dark:border-white/[0.08]"><img data-v-15fa41d2="" class="user_avatar h-full w-full object-cover" src="<?=Yii::$app->request->baseUrl?>/modx/<?=($user->attribut->photo!='')?$user->attribut->photo:'images/user_photo/user_icon.png'?>"></div>
                     <!---->
                  </div>
            ...
            <div data-v-15fa41d2="" class="account-sidebar mt-8 hidden md:block">
               <ul data-v-15fa41d2="">
                  <!----> <!---->
                  <li data-v-15fa41d2="">
                     <a data-v-15fa41d2="" href="<?=Url::to(['user/account'])?>"  aria-current="page">
...
<!--                            <div>Withdrawals are made once a month from the 1st to the 3rd day of each month.</div>-->
                  ...
                  <li data-v-15fa41d2="">
                     <a data-v-15fa41d2="" href="<?=Url::to(['user/dashboard'])?>" class="nuxt-link-exact-active nuxt-link-active">
                  ...
                  <li data-v-15fa41d2="">
                     <a data-v-15fa41d2="" href="<?=Url::to(['user/following'])?>" class="">
               ...
               <div data-v-15fa41d2="" class="account-sidebar-mobile relative">
                  <div data-v-15fa41d2="" class="account-sidebar !top-full !mt-3 hidden !w-full !transform-none">
                     <ul data-v-15fa41d2="">
                        <!----> <!---->
                        <li data-v-15fa41d2="">
                           <a data-v-15fa41d2="" href="<?=Url::to(['user/account'])?>" class="nuxt-link-exact-active nuxt-link-active" aria-current="page">
                              <svg data-v-15fa41d2="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-6 h-5 w-5 shrink-0">
                                 <path fill-rule="evenodd" clip-rule="evenodd" d="M7.04413 2.60614C7.88098 1.76928 9.03916 1.25 10.3175 1.25C11.5958 1.25 12.754 1.76928 13.5909 2.60614C14.427 3.4423 14.9462 4.6005 14.9462 5.87873C14.9462 7.15696 14.427 8.31516 13.5909 9.15132C12.754 9.98818 11.5958 10.5075 10.3175 10.5075C9.03916 10.5075 7.88098 9.98818 7.04413 9.15132C6.20797 8.31516 5.68877 7.15696 5.68877 5.87873C5.68877 4.6005 6.20797 3.4423 7.04413 2.60614Z" fill="currentColor"></path>
                                 <path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 16.0606C3.75 13.5038 6.50544 11.4319 10.3181 11.4319C12.2194 11.4319 13.8326 11.9532 14.9905 12.7848C16.1405 13.6108 16.8862 14.7852 16.8862 16.0606C16.8862 16.6294 16.5373 17.0636 16.1806 17.3542C15.811 17.6553 15.3164 17.903 14.7565 18.101C13.6294 18.4997 12.0867 18.75 10.3181 18.75C8.4424 18.75 6.8953 18.501 5.78912 18.0988C5.23886 17.8987 4.76047 17.6473 4.40559 17.3387C4.05504 17.0339 3.75 16.6026 3.75 16.0606ZM15.3913 16.0207L15.3908 16.022L15.3913 16.0207Z" fill="currentColor"></path>
                              </svg>
                  ...
                  <button data-v-15fa41d2="" type="button" class="flex w-full items-center rounded-lg border-2 border-[#704DFD] bg-white px-4 py-2 text-left text-sm dark:bg-black">
                     <svg data-v-15fa41d2="" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" class="mr-5 h-5 w-5 shrink-0">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.04413 2.60614C7.88098 1.76928 9.03916 1.25 10.3175 1.25C11.5958 1.25 12.754 1.76928 13.5909 2.60614C14.427 3.4423 14.9462 4.6005 14.9462 5.87873C14.9462 7.15696 14.427 8.31516 13.5909 9.15132C12.754 9.98818 11.5958 10.5075 10.3175 10.5075C9.03916 10.5075 7.88098 9.98818 7.04413 9.15132C6.20797 8.31516 5.68877 7.15696 5.68877 5.87873C5.68877 4.6005 6.20797 3.4423 7.04413 2.60614Z" fill="currentColor"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 16.0606C3.75 13.5038 6.50544 11.4319 10.3181 11.4319C12.2194 11.4319 13.8326 11.9532 14.9905 12.7848C16.1405 13.6108 16.8862 14.7852 16.8862 16.0606C16.8862 16.6294 16.5373 17.0636 16.1806 17.3542C15.811 17.6553 15.3164 17.903 14.7565 18.101C13.6294 18.4997 12.0867 18.75 10.3181 18.75C8.4424 18.75 6.8953 18.501 5.78912 18.0988C5.23886 17.8987 4.76047 17.6473 4.40559 17.3387C4.05504 17.0339 3.75 16.6026 3.75 16.0606ZM15.3913 16.0207L15.3908 16.022L15.3913 16.0207Z" fill="currentColor"></path>
                     </svg>
                     <div data-v-15fa41d2="" class="truncate">
                        <div data-v-15fa41d2="">Account settings</div>
                        <p data-v-15fa41d2="" class="sub-title truncate">Change your avatar, user name, credentials, etc.</p>
                     </div>
         ...
         <div data-v-15fa41d2="" class="w-full md:pl-64 lg:pl-80">
            <div data-v-15fa41d2="" class="mx-auto ">
<!--------------------------------------------------------------------------------------->
<!--<div class="mb-10 sm:flex sm:items-center">
   <span>
      <span class="" style="display: none;">
         <div class="popper !z-[39] text-sm filter-dropdown p-2">
            <ul>
               <li><button type="button" class="flex w-full rounded-lg py-2.5 px-3.5 hover:bg-black/[0.06] dark:hover:bg-[#4f4f4f]">
                  Custom
                  </button>
               </li>
               <li><button type="button" class="flex w-full rounded-lg py-2.5 px-3.5 hover:bg-black/[0.06] dark:hover:bg-[#4f4f4f]">
               ...
               <li><button type="button" class="flex w-full rounded-lg py-2.5 px-3.5 hover:bg-black/[0.06] dark:hover:bg-[#4f4f4f] bg-black/[0.06] dark:bg-[#4f4f4f]">
                  Last 14 days
                  </button>
               </li>
               <li><button type="button" class="flex w-full rounded-lg py-2.5 px-3.5 hover:bg-black/[0.06] dark:hover:bg-[#4f4f4f]">
      ...
      <button type="button" class="inline-flex w-auto items-center rounded-full border-2 border-black/[0.16] bg-white px-5 py-3 text-left text-[15px] dark:border-white/[0.16] dark:bg-black">
         <div class="mr-3">Date Range: Last 14 days</div>
         <span class="ml-auto">
...
<!--------------------------------------------------------------------------------------->
<div data-v-ef3d8098="" class="md:overflow-y-auto">
   <table data-v-ef3d8098="" class="seller-dashboard-table">
      <thead data-v-ef3d8098="">
         <tr data-v-ef3d8098="" class="hidden md:table-row">
            <th data-v-ef3d8098="" class="!pl-0" col="1" order="DESC">
               <div data-v-ef3d8098="" class="whitespace-nowrap text-xl font-bold">Packs</div>
            </th>
            <th data-v-ef3d8098="" class="" col="2" order="ASC">
               <div data-v-ef3d8098="" class="flex items-center justify-center">
                  <button data-v-ef3d8098="" type="button" class="flex items-center"><span data-v-ef3d8098="">Conversion</span></button>
                  <svg data-v-ef3d8098="" width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2.5 inline">
                     <path class="asc" d="M4.50087 1.07812L8.05642 6.03435L0.945313 6.03435L4.50087 1.07812Z" fill="currentColor" fill-opacity="0.24"></path>
                     <path class="desc" d="M4.50108 14.9219L0.94553 9.96565L8.05664 9.96565L4.50108 14.9219Z" fill="currentColor" fill-opacity="0.24"></path>
                  </svg>
                  <div data-v-ef3d8098="" data-tippy-component="" interactive="" arrow="" max-width="180">
                     <div data-tippy-component-trigger=""></div>
                  </div>
               </div>
            </th>
            <th data-v-ef3d8098="" class="" col="3" order="ASC">
               <div data-v-ef3d8098="" class="flex items-center justify-center">
                  <button data-v-ef3d8098="" type="button" class="flex items-center">
                     <span data-v-ef3d8098="">Plays</span>
                     <svg data-v-ef3d8098="" width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2.5 inline">
                        <path class="asc" d="M4.50087 1.07812L8.05642 6.03435L0.945313 6.03435L4.50087 1.07812Z" fill="currentColor" fill-opacity="0.24"></path>
                        <path class="desc" d="M4.50108 14.9219L0.94553 9.96565L8.05664 9.96565L4.50108 14.9219Z" fill="currentColor" fill-opacity="0.24"></path>
                     </svg>
            ...
            <th data-v-ef3d8098="" class="" col="4" order="ASC">
               <div data-v-ef3d8098="" class="flex items-center justify-center">
                  <button data-v-ef3d8098="" type="button" class="flex items-center">
                     <span data-v-ef3d8098="">Downloads</span>
                     <svg data-v-ef3d8098="" width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2.5 inline">
                        <path class="asc" d="M4.50087 1.07812L8.05642 6.03435L0.945313 6.03435L4.50087 1.07812Z" fill="currentColor" fill-opacity="0.24"></path>
                        <path class="desc" d="M4.50108 14.9219L0.94553 9.96565L8.05664 9.96565L4.50108 14.9219Z" fill="currentColor" fill-opacity="0.24"></path>
                     </svg>
            ...
            <th data-v-ef3d8098="" class="highlight" col="5" order="DESC">
               <div data-v-ef3d8098="" class="flex items-center justify-center">
                  <button data-v-ef3d8098="" type="button" class="flex items-center">
                     <span data-v-ef3d8098="">Revenue</span>
                     <svg data-v-ef3d8098="" width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="ml-2.5 inline">
                        <path class="asc" d="M4.50087 1.07812L8.05642 6.03435L0.945313 6.03435L4.50087 1.07812Z" fill="currentColor" fill-opacity="0.24"></path>
                        <path class="desc" d="M4.50108 14.9219L0.94553 9.96565L8.05664 9.96565L4.50108 14.9219Z" fill="currentColor" fill-opacity="1"></path>
                     </svg>
                  </button>
               </div>
            </th>
      ...
      <tbody data-v-ef3d8098="" class="tbody-dashboard">
        <?php if(isset($packs_creator)):?>
        <?php foreach ($packs_creator as $key => $pack) :?>
         <tr data-v-ef3d8098="">
            <td data-v-ef3d8098="" col="1">
               <div data-v-ef3d8098="" class="flex items-center font-medium">
                  <span data-v-ef3d8098="" class="mr-4 min-w-[16px]"><?=$key+1?></span>
                  <div data-v-ef3d8098="" class="h-8 w-8 shrink-0 overflow-hidden rounded border border-black/[0.08] dark:border-white/[0.08]"><img data-v-ef3d8098="" alt="" class="h-full w-full object-cover" src="<?=Yii::$app->request->baseUrl?>/modx/<?=$pack['img']?>"></div>
                  <span data-v-ef3d8098="" class="title ml-3 max-w-[200px] truncate sm:max-w-[400px] md:max-w-[150px] xl:max-w-[300px]"><?=$pack['title']?></span>
               </div>
            </td>
            <td data-v-ef3d8098="" class="text-center" col="2">
               <div data-v-ef3d8098=""><?=$pack['conversion']?>%</div>
            </td>
            <td data-v-ef3d8098="" class="text-center" col="3">
               <div data-v-ef3d8098=""><?=(isset($pack['views']))?$pack['views']:0?></div>
            </td>
            <td data-v-ef3d8098="" class="text-center" col="4">
               <div data-v-ef3d8098=""><?=(isset($pack['downloads']))?$pack['downloads']:0?></div>
            </td>
            <td data-v-ef3d8098="" class="text-center highlight" col="5">
               <div data-v-ef3d8098=""><?=$pack['revenue']?></div>
            </td>
         </tr>
       <?php endforeach; ?>
       <?php endif; ?>
   ...
   <center style="margin-top:20px"><button class="btn-white2 add_load" limit="10" col="5" order="DESC">Load more</button></center>
</div>
<!--------------------------------------------------------------------------------------->
            </div>
         </div>
...
$('.seller-dashboard-table thead th').click(function(){
  //$(this).addClass('highlight');
  var col = $(this).attr('col');
  var order = $(this).attr('order');
  var limit = $('.add_load').attr('limit');

  if (order=='ASC') {
    $(this).attr('order','DESC');
    order='DESC';
    $(this).find('.asc').attr('fill-opacity','0.24');
    $(this).find('.desc').attr('fill-opacity','1');
  } else {
    $(this).attr('order','ASC');
    order='ASC';
    $(this).find('.asc').attr('fill-opacity','1');
    $(this).find('.desc').attr('fill-opacity','0.24');
  }
  $('.add_load').attr('col',col);
  $('.add_load').attr('order',order);
  //alert(col);
  $.ajax({
        method: "POST",
        url: '$baseUrl/ajax/sort_dashboard',
        data: { col: col, order: order, limit:limit}
      })
        .done(function( rez ) {
          $('.tbody-dashboard').html(rez);
          //alert(rez);
          $('.seller-dashboard-table thead th').removeClass('highlight');
          $('.seller-dashboard-table tbody td').removeClass('highlight');
          $('[col='+col+']').addClass('highlight');
        });
});
$('.add_load').click(function(){
  ...
  $.ajax({
        ...
        .done(function( rez ) {
          ...
          $('.seller-dashboard-table tbody td').removeClass('highlight');
          $('[col='+col+']').addClass('highlight');
          var id = $('.tbody-dashboard').find('tr').length;
          if (id<limit) $('.add_load').hide();
        });
...
<style>
  ...
  .seller-dashboard-table[data-v-67d7afa2] {
      min-width: 100%;
      border-collapse: collapse;
      text-align: left
  }

  .seller-dashboard-table thead tr th[data-v-67d7afa2] {
  ...
  .seller-dashboard-table tbody tr td[data-v-67d7afa2] {
      padding: .5rem 1.25rem
  }

  .seller-dashboard-table tbody tr[data-v-67d7afa2] {
      --tw-text-opacity: 1;
      color: rgb(92 92 92/var(--tw-text-opacity))
  }

  .dark .seller-dashboard-table tbody tr[data-v-67d7afa2] {
      --tw-text-opacity: 1;
      color: rgb(183 183 183/var(--tw-text-opacity))
  }

  .seller-dashboard-table tbody tr:nth-child(2n) td[data-v-67d7afa2] {
      background-color: rgb(0 0 0/.04)
  }

  .dark .seller-dashboard-table tbody tr:nth-child(2n) td[data-v-67d7afa2] {
      background-color: rgb(255 255 255/.04)
  }

  .seller-dashboard-table tbody tr:nth-child(2n) td[data-v-67d7afa2]:first-child {
      border-top-left-radius: .5rem;
      border-bottom-left-radius: .5rem
  }

  .seller-dashboard-table tbody tr:nth-child(2n) td[data-v-67d7afa2]:last-child {
      border-top-right-radius: .5rem;
      border-bottom-right-radius: .5rem
  }

  .seller-dashboard-table thead tr th.highlight[data-v-67d7afa2] {
      padding: 0
  }

  .seller-dashboard-table thead tr th.highlight>div[data-v-67d7afa2] {
      padding: .75rem 1.25rem;
      line-height: 1.75rem
  }
  ...
  @media (min-width: 768px) {
      ...
      .dark .seller-dashboard-table thead tr th.highlight>div[data-v-67d7afa2] {
          background-color: rgb(255 255 255/.04)
      }

      .seller-dashboard-table tr:last-child td.highlight>div[data-v-67d7afa2] {
  ...
  .seller-dashboard-table tbody tr td[data-v-67d7afa2]:not(:first-child) {
      display: none
  }
  ...
  .seller-dashboard-table tbody tr td.highlight[data-v-67d7afa2] {
      display: table-cell;
      padding: 0
  }

  .seller-dashboard-table tbody tr td.highlight>div[data-v-67d7afa2] {
      padding: .5rem 1.25rem;
      line-height: 2rem
  }
  ...
  @media (min-width: 768px) {
      ...
      .dark .seller-dashboard-table tbody tr td.highlight>div[data-v-67d7afa2] {
          background-color: rgb(255 255 255/.04)
      }
  }

  @media screen and (max-width: 400px) {
      .seller-dashboard-table .title[data-v-67d7afa2] {
          max-width:150px
      }
  }
