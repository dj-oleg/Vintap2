      ...
      <div class="-mt-7 md:mt-0" data-v-15fa41d2="">
         ...
         <div class="w-full md:pl-64 lg:pl-80" data-v-15fa41d2="">
            <div data-v-15fa41d2="">
               ...
               <h1 class="mt-5 text-[33px] font-medium leading-10">
                  Edit pack
               </h1>
               <div>
                  <!---->
                  ...
                  <form data-v-7d749ad6="" method="post" action="<?=Url::to(['user/edit_pack'])?>/<?=$pack['id']?>">

                    <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />

                    <div class="grid md:grid-cols-2 gap-5  max-w-2xl" data-v-15abc323="">

                      <div data-v-15abc323="" class="mt-5 max-w-xs">
                        <p class="mt-2 opacity-80">Title:</p>
                        <div data-v-15abc323="">
                          <input type="text" placeholder="Title" data-v-15abc323 name="title" class="form-field" value="<?=$pack['title']?>" required>
                       </div>

                       <p class="mt-2 opacity-80">Description:</p>
                       <div data-v-15abc323="">
                         <textarea rows="5" placeholder="Description" data-v-15abc323 name="description" class="form-field" ><?=$pack['description']?></textarea>
                      </div>

                       <br>
                       <button data-v-15abc323="" class="w-full btn" type="submit">
                         ...
                         <span class=""><i class="fa-solid fa-floppy-disk"></i> Save changes</span>
                       </button>
                      </div>
                      <div data-v-15abc323="" class="mt-5 max-w-xs">
                        <p class="mt-2 opacity-80">Image:</p>
                        <img src="<?=Yii::$app->request->baseUrl?>/modx/<?=(isset($pack['img']))?$pack['img']:'images/packs/noimage.jpg'?>" class="img_pack rounded" style="height:225px; margin-bottom:15px;">

                        <button type="button" class="show_modal_change_avatar btn-purple  bg-black/[0.48] hover:bg-black/[0.52] dark:bg-white/[0.16] dark:hover:bg-white/[0.2]" style="width:225px; display:block;">
                           Change image
                  ...
                  <h2 class="mt-5 text-[22px] font-medium leading-10">Samples</h2>
<button type="button" id="btn_add_sample" class="btn"><i class="fa-solid fa-circle-plus"></i> Add new sample</button>
                      <?php if(isset($sounds)):?>
                       <?php foreach ($sounds as  $sound):
                         $instruments=$this->context->get_instruments($sound['id']);
                         $genres=$this->context->get_genres($sound['id']);
                         //echo2($genres);
                         ?>
                         <form data-v-7d749ad6="" method="post" action="<?=Url::to(['user/edit_sample'])?>" enctype="multipart/form-data">
                         <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                         <input type="hidden" name="pack_id" value="<?=$pack['id']?>" />
                         <input type="hidden" name="sound_id" value="<?=$sound['id']?>" />

                         <div class="group lg:hover:bg-black/[0.06] dark:lg:hover:bg-[#2d2d2d]" style="padding:10px 0px 10px 20px; border-radius:15px">
                        <div class="mt-15 grid md:grid-cols-3" data-v-15abc323="">

                            <div data-v-15abc323="" class="max-w-xs">
                              <div  data-v-12cfc155>
                                <p class="mt-2 opacity-80">Title:</p>
                                <input type="text" placeholder="Title" data-v-15abc323 name="title" class="form-field" value="<?=$sound['title']?>">
                              </div>
                            </div>
                            <div data-v-15abc323="" class="max-w-xs">
                               <p class="mt-2 opacity-80">File:</p>
                               <label class="form-field" type="text" style="position: relative;word-wrap:break-all; overflow-x:hidden;overflow-y:hidden; margin-top:0; padding:10px; height:45px;">
                                  <input type="file" name="filesound" class="filesound" style="display: none;">
                                  <i style="white-space: nowrap; width:100px; height:43px; overflow: hidden; text-overflow: ellipsis;"><?=($sound['file']!="")?explode("/", $sound['file'])[2]:""?></i>
                                  <span class="btn" style="position:absolute;top:0px;right:1px;">File</span>
                              </label>
                              <!--
                              <label class="form-control" style="word-wrap:break-all; overflow-x:hidden;overflow-y:hidden;">
                                                      <input type="file" name="fileimg" style="display: none;">
                                                      <i class="btn" id="name_img" style="color:#636e72; white-space: nowrap; width:171px; height:35px;overflow: hidden; text-overflow: ellipsis;"></i>
                                                      <span class="btn" style="background-color:#dfe6e9; float: right;">Выбрать файл</span>
                                                  </label>
                              -->
                            </div>
                            <div data-v-15abc323="" class="max-w-xs mt-7" style="padding:0 25px 0 25px">
                              <button data-v-15abc323="" class="w-full btn savefile" type="submit" name="action" value="Update">
                                <span class="spin w-4"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="animate-spin"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" class="opacity-25"></circle> <path fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" class="opacity-75"></path></svg></span>
                                <span class=""><i class="fa-solid fa-floppy-disk"></i> Save changes</span>
                              </button>
                           </div>
                           ...
                           <div data-v-15abc323="" class=" max-w-xs">
                             <p class="mt-2 opacity-80">Instruments:</p>
                          ...
                          <div data-v-15abc323="" class="max-w-xs mt-6 grid md:grid-cols-2" style="padding:0 25px 0 25px">
                            <div data-v-15abc323="" class=" max-w-xs" style="margin-top:-16px;margin-right:2px;">
                              <p class="opacity-80">Price:</p>
                              <input type="number" class="form-field price" step="0.01" name="price" value="<?=intval($sound['price'])?>" min="0.01">
                            </div>
                            <div data-v-15abc323="" class=" max-w-xs" style="padding-top:4px;">
                               <button data-v-15abc323="" class="w-full btn btn-del" type="submit" name="action" value="Delete">
                                 <span class="spin w-4"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="animate-spin"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" class="opacity-25"></circle> <path fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" class="opacity-75"></path></svg></span>
                                 <span class=""><!--<i class="fa-solid fa-delete-left"></i>--> Delete</span>
                               </button>
                             </div>
                          </div>
                        </div>
 ...
 <div class="animated modal-popup-container2 absolute inset-0 h-full w-full text-center px-3">
    <div class="inline-block w-full text-left align-middle">
       <div id="modal_add_sample" class="relative mx-auto max-w-full rounded-2xl bg-white px-7 pt-7 pb-9 text-black shadow-lg dark:bg-121212 dark:text-white my-8" style="width: 760px;">
          ...
          <div>
             <h3 class="mb-10 text-center text-2xl font-medium">Add new Sample</h3>

               <form data-v-7d749ad6="" method="post" action="<?=Url::to(['user/add_sample'])?>" enctype="multipart/form-data">
               <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
               <input type="hidden" name="pack_id" value="<?=$pack['id']?>" />
               <div class="mt-10 grid md:grid-cols-2   max-w-2xl" data-v-15abc323="">

                   <div data-v-15abc323="" class="max-w-xs">
                     <div  data-v-12cfc155>
                       <p class="mt-2 opacity-80">Title:</p>
                       <input type="text" placeholder="Title" data-v-15abc323 name="title" class="form-field" value="" required>
                     </div>
                   </div>
                   <div data-v-15abc323="" class="max-w-xs">
                      <p class="mt-2 opacity-80">File:</p>
                      <label class="form-field" type="text" style="position: relative;word-wrap:break-all; overflow-x:hidden;overflow-y:hidden; margin-top:0; padding:10px; height:45px;">
                         <input type="file" name="filesound" class="filesound" style="display: none;">
                         <i style="white-space: nowrap; width:100px; height:43px; overflow: hidden; text-overflow: ellipsis;"></i>
                         <span class="btn" style="position:absolute;top:0px;right:1px;">File</span>
                     </label>
                   </div>
                   <div data-v-15abc323="" class=" max-w-xs">
                  ...
                  <div data-v-15abc323="" class=" max-w-xs">
                    ...
                    <select class="js-example-basic-multiple form-field" name="instruments[]" multiple="multiple" data-placeholder="Select an genre">
                       ...
                       <option value="Horns & Flutes">Horns & Flutes</option>
             ...
             <div class="mt-10 text-center">
                <button class="btn savefile" type="submit" >
                   <span class="spin w-4">
                      <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="animate-spin">
                         <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" class="opacity-25"></circle>
                         <path fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" class="opacity-75"></path>
                   ...
                   <span class=""><i class="fa-solid fa-floppy-disk"></i> Add new sample</span>
                </button>
             </div>
           </form>
          </div>
...
$this->registerJsFile(Yii::$app->request->baseUrl . '/newcrop/cropper.js', ['depends' => [yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl . '/newcrop/jquery-cropper.js', ['depends' => [yii\web\JqueryAsset::className()]]);
//$this->registerCssFile(Yii::$app->request->baseUrl . '/newcrop/cropper.css', ['depends' => [yii\web\JqueryAsset::className()]]);
$this->registerCssFile(Yii::$app->request->baseUrl . '/newcrop/cropper.css');
?>
<?php
