      ...
      <div class="-mt-7 md:mt-0" data-v-15fa41d2="">
         ...
         <div class="w-full md:pl-64 lg:pl-80" data-v-15fa41d2="">
            <div data-v-15fa41d2="">
               ...
               <h1 class="mt-10 text-[33px] font-medium leading-10">
                  Downloads
                  <span class="text-[#747474]"><?=(isset($user_paid_samles[0])&&($user_paid_samles[0]==1))?'0':count($user_paid_samles)?></span>
               </h1>
               <div class="mt-12">
                  <div class="sticky mb-1.5 flex items-center py-1 lg:mb-6 top-[147px] lg:top-[130px] z-[31] !bg-[#fbfbfb] dark:!bg-[#111111]">
                          ...
                          <?php if (isset($packs)): ?>
                            ...
                            <?php foreach ($packs as $key => $pack):?>
                             <div class="group relative flex items-center py-3 last:pb-0">
                                <div class="relative shrink-0 overflow-hidden rounded bg-black bg-opacity-10">
                                   <div class="pointer-events-none absolute inset-0 flex h-full w-full items-center justify-center bg-black bg-opacity-40 text-white transition-opacity focus:outline-none group-hover:opacity-100 opacity-0">
                                       <button audio_id="<?=$pack['id']?>" class="pointer-events-auto absolute inset-0 flex h-full w-full items-center justify-center bg-black bg-opacity-40 text-white transition-opacity focus:outline-none group-hover:opacity-100">
                                   ...
                                   <span class="hidden"></span> <img loading="lazy" data-src="<?=Yii::$app->request->baseUrl?>/modx/<?=$pack['img']?>" src="<?=Yii::$app->request->baseUrl?>/modx/<?=(isset($pack['img']))?$pack['img']:'images/packs/noimage.jpg'?>" class="h-11 w-11 rounded object-cover md:h-16 md:w-16">
                                </div>
                                <div class="ml-5 flex flex-1 items-center truncate font-medium md:block">
                                   ...
                                   <div class="ml-auto flex items-center md:ml-0">
                                      ...
                                      <!-- <a href="/modx/<?=$pack['zip_file']?>" download class="hidden h-8 w-8 items-center justify-center rounded-full bg-black/[0.08] backdrop-blur-lg dark:bg-white/[0.16] lg:flex" style="color:#55efc4; margin-left: 20px; margin-top:-30px;"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3" data-v-12cfc155>
                                      ...
                                      <!-- My code -->
                                      <a href="/modx/<?=$pack['zip_file']?>" download class="hidden h-8 w-8 items-center justify-center rounded-full bg-black/[0.08] backdrop-blur-lg dark:bg-white/[0.16] lg:flex" style="color:#55efc4; margin-left: 20px; margin-top:5px;"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3" data-v-12cfc155>
                                        <path d="M11.8857 6.83557L8.45723 10.4355C8.22866 10.7212 7.77153 10.7212 7.54297 10.4355L4.11449 6.89271C3.82878 6.54986 4.11449 6.09273 4.57162 6.09273H6.85727C6.85727 6.09273 6.74299 3.40709 6.85727 2.09284C6.91441 1.46428 7.37154 0.950012 8.0001 0.950012C8.62865 0.950012 9.08578 1.46428 9.14292 2.09284C9.25721 3.46423 9.14292 6.09273 9.14292 6.09273H11.4286C11.8857 6.09273 12.1714 6.54986 11.8857 6.83557Z" class="fill-current"></path><path d="M2.9 13.25C2.40294 13.25 2 13.653 2 14.15C2 14.6471 2.40294 15.05 2.9 15.05H13.1C13.5971 15.05 14 14.6471 14 14.15C14 13.653 13.5971 13.25 13.1 13.25H2.9Z" class="fill-current"></path></svg>
                                      </a>
               ...
               <!--<div class="mt-10 text-center"><button type="button" class="btn">Subscribe for more</button></div>-->
            </div>
         </div>
