         ...
         <div data-v-15fa41d2="" class="md:float-left md:w-[228px]">
            ...
            <div data-v-15fa41d2="" class="account-sidebar mt-8 hidden md:block">
               <ul data-v-15fa41d2="">
                  <!----> <!---->
                   <li data-v-15fa41d2="">
                     <div style="padding-left:15px;padding-bottom:7px;padding-top:7px;">Withdrawals are made once a month from the 1st to the 3rd day of each month.</div>
                   </li>
...
<!--                        <div>Withdrawals are made once a month from the 1st to the 3rd day of each month.</div>-->
         ...
         <div data-v-15fa41d2="" class="w-full md:pl-64 lg:pl-80">
            <div data-v-15fa41d2="" class="mx-auto max-w-[550px]">
               <h2 class="text-[33px] font-medium leading-10">Edit account</h2>
               <div class="mt-10 flex items-center">
                  <div class="mr-6 h-[102px] w-[102px] shrink-0 overflow-hidden rounded-full border border-black/[0.08] dark:border-white/[0.08]"><img class="user_avatar h-full w-full object-cover" src="<?=Yii::$app->request->baseUrl?>/modx/<?=($user->attribut->photo!='')?$user->attribut->photo:'images/user_photo/user_icon.png'?>"></div>
               ...
               <div class="mt-7">
                  <form data-v-7d749ad6="" method="post" action="<?=Url::to(['user/change_account'])?>">
                    <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                     <div data-v-7d749ad6="" class="grid gap-7 text-xs font-medium text-5c5c5c dark:text-b7b7b7">
                        <div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Full name</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm" value="<?=$user->attribut->fullname?>" name="fullname">
                        </div>
                        <!--<div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Last name</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm">
                        </div>-->
                        <div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Account name / Email</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm" value="<?=$user->username?>" name="username">
                        </div>
                        <!--<div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Email</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm" value="<?=$user->attribut->email?>" name="email">
                        </div>-->
                        <!--<div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Bio</p>
                           <textarea data-v-7d749ad6="" class="form-field form-field-sm min-h-[140px]"></textarea>
                        </div>-->
                        <div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Your Paypal email</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm" value="<?=$user->attribut->website?>" name="website">
                        </div>
                        <!--<div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Email (Public)</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm">
                        </div>
                        <div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Instagram URL</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm">
                        </div>
                        <div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">YouTube URL</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm">
                        </div>
                        <div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">Twitter URL</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm">
                        </div>
                        <div data-v-7d749ad6="">
                           <p data-v-7d749ad6="" class="mb-1">TikTok URL</p>
                           <input data-v-7d749ad6="" type="text" class="form-field form-field-sm">
                        </div>-->
                        <div data-v-7d749ad6="" class="text-right">
                           <button data-v-7d749ad6="" class="py-3.5 px-6 leading-5 btn-purple" type="submit">
                              <span class="spin w-4">
...
$("#crop").click(function(){
    ...
    $(".user_avatar").attr('src',srcOriginal);
    $.ajax({
        type: "POST",
