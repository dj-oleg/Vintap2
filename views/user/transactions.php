   ...
   <div class="w-full">
      <div class="-mt-7 md:mt-0" data-v-15fa41d2="">
         <div class="md:float-left md:w-[228px]" data-v-15fa41d2="">
            ...
            <div class="account-sidebar mt-8 hidden md:block" data-v-15fa41d2="">
               <ul data-v-15fa41d2="">
                  ...
                  <li data-v-15fa41d2="">
                     <a href="<?=Url::to(['user/downloads'])?>" data-v-15fa41d2="" class="">
                  ...
                  <li data-v-15fa41d2="">
                     <a href="<?=Url::to(['user/transactions'])?>" data-v-15fa41d2="" class="nuxt-link-exact-active nuxt-link-active" aria-current="page">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-6 h-5 w-5 shrink-0" data-v-15fa41d2="">
         ...
         <div class="w-full md:pl-64 lg:pl-80" data-v-15fa41d2="">
            <div data-v-9d4b9104="" data-v-15fa41d2="">
               <div data-v-9d4b9104="" class="flex items-center text-[13px]">
                  <a data-v-9d4b9104="" href="<?=Url::to(['user/account'])?>" class="mr-2 hover:underline nuxt-link-active">
                  My account
                  </a>
                  <span data-v-9d4b9104="" class="inline-flex items-center text-5c5c5c dark:text-[#b7b7b7]">
                     <svg data-v-9d4b9104="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2 h-3 w-3 rotate-180">
               ...
               <h1 data-v-9d4b9104="" class="mt-10 text-[33px] font-medium leading-10">
                  Credit transactions
                  <span data-v-9d4b9104="" class="text-[#747474]"><?=(isset($transactions))?count($transactions):0?></span>
               </h1>
               <div data-v-9d4b9104="" class="mt-10 overflow-y-auto md:max-w-xl">
                  <table data-v-9d4b9104="" class="account-table w-full">
                     <thead data-v-9d4b9104="">
                        <tr data-v-9d4b9104="">
                           <th data-v-9d4b9104="" class="text-center">Purchase date</th>
                           <th data-v-9d4b9104="" class="text-center">Transaction type</th>
                           <th data-v-9d4b9104="" class="text-center">Amount</th>
                           <th data-v-9d4b9104="" class="text-center">Sample</th>
                        </tr>
                     </thead>

                     <tbody data-v-9d4b9104="">
                       <?php if(isset($transactions)):

                          ?>
                       <?php foreach ($transactions as $transaction): $date = date_create($transaction['date']); ?>
                        <tr data-v-9d4b9104="" >
                           <td data-v-9d4b9104="" colspan="1"><?=date_format($date,"d M, Y")?></td>
                           <td data-v-9d4b9104="" colspan="1">Buy</td>
                           <td data-v-9d4b9104="" colspan="1"><?=$transaction['paypal_sum']?></td>
                           <td data-v-9d4b9104="" colspan="1" style="text-align:left;"><?=$transaction['title']?></td>
                          </tr>
                      <?php endforeach; ?>
                      <?php else: ?>
                        <tr data-v-9d4b9104="">
                           <td data-v-9d4b9104="" colspan="4">No transactions available.</td>
                        </tr>
                      <?php endif; ?>
                     </tbody>
                  </table>
         ...
         <div class="clear-both" data-v-15fa41d2=""></div>
         <div class="fixed inset-0 z-60 h-full w-full overflow-x-hidden bg-black bg-opacity-80 dark:bg-[#2c2c2c] dark:bg-opacity-70 hidden overflow-y-auto" data-v-15fa41d2="">
            <div class="animated modal-popup-container absolute inset-0 h-full w-full text-center px-3">
               <div class="inline-block w-full text-left align-middle">
                  <div class="relative mx-auto max-w-full rounded-2xl bg-white px-7 pt-7 pb-9 text-black shadow-lg dark:bg-121212 dark:text-white my-8" style="width:376px;">
                     ...
                     <form class="grid grid-cols-1 gap-4 sm:px-5" data-v-15fa41d2="">
                        <h3 class="mb-5 text-center text-2xl font-medium" data-v-15fa41d2="">Insufficient balance</h3>
                        <p class="text-center text-base text-5c5c5c dark:text-b7b7b7" data-v-15fa41d2="">Once your balance is greater than $10, you can request a payout via Paypal.</p>
                     </form>
                  </div>
               </div>
            </div>
