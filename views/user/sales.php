...
?>
<?php if(isset($sales_history[0])):?>  
<form  method="post" action="<?=Url::to(['user/sales'])?>">
<input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
<div class="scroll-table">
<table class="seller-dashboard-table">
<thead>
<tr>
    <th>transaction id paypal</th>
    <th>date</th>
    <!--<th>promocode</th>-->
    <th>pack id</th>
    <!--<th>buyer_user_id</th>-->
    ...
    <!--<th>paypal_sum</th>-->
    <!--<th>price_pack</th>-->
    <!--<th>site_commission_sum</th>-->
    <th>sum for author</th>
    <th>status</th>
</tr>
</thead>
...
<?php foreach($sales_history as $sale):?>
    <tr>
    <td><?=$sale->transaction_id_paypal?></td>
    <td><?=$sale->date?></td>
    <!--<td><?=$sale->promocode?></td>-->
    <td><?=$sale->pack_id?></td>
    <!--<td><?=$sale->creator_user_id?></td>-->
    <td><?=$this->context->user_paypal($sale->creator_user_id)?></td> 
    <!--<td><?=$sale->is_coauthor?></td>-->
    <!--<td><?=$sale->paypal_sum?></td>-->
    <!--<td><?=$sale->price_pack?></td>-->
    <!--<td><?=$sale->site_commission_sum?></td>-->
    <td>$ <?=$sale->sum_for_author?></td>
    <td>
    <select name="<?=$sale->id?>" class="form-field ">
        <option <?=($sale->status=='not paid to the seller')?'selected':''?>  value="not paid to the seller">not paid to the seller</option>
        <option <?=($sale->status=='done')?'selected':''?> value="done">done</option>
    </select>
    </td>
</tr>
</tbody>
